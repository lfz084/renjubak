    ...
    function(e) {
        function n(t) {
            ...
            this.unsubscribe = function(t) {
                for (var e in n) if (n[e][t]) return delete n[e][t],
                !0;
                return ! 1
            },
            this.publish = function(r) {
                if (n.hasOwnProperty(r)) {
                    ...
                    o = [];
                    for (var s in n[r]) if (Object.prototype.hasOwnProperty.call(n[r], s)) {
                        var a = n[r][s];
                        try {
                            a[0].apply(t, i)
                        } catch(t) {
        ...
        function i(a, c, h, l) {
            var u = {};
            "object" === (void 0 === a ? "undefined": t(a)) && (a = (u = a).orientation, c = u.unit || c, h = u.format || h, l = u.compress || u.compressPdf || l),
            c = c || "mm",
            h = h || "a4",
            a = ("" + (a || "P")).toLowerCase(); ("" + h).toLowerCase();
            var p, f, d, g, m, w, y, v, b, x = !!l && "function" == typeof Uint8Array,
            S = u.textColor || "0 g",
            k = u.drawColor || "0 G",
            C = u.fontSize || 16,
            I = u.charSpace || 0,
            ...
            J = function(t) {
                return ("0" + parseInt(t, 10)).slice( - 2)
            },
            Q = function(t) {
                O ? R[g].push(t) : (z += t.length + 1, M.push(t))
            },
            K = function() {
                return q++,
                P[q] = z,
            ...
            $ = function() {
                var t, n, r, o, s, a, c, h, l, u = [];
                for (c = e.adler32cs || i.adler32cs, x && void 0 === c && (x = !1), t = 1; t <= B; t++) {
                    if (u.push(K()), h = (m = j[t].width) * f, l = (w = j[t].height) * f, Q("<</Type /Page"), Q("/Parent 1 0 R"), Q("/Resources 2 0 R"), Q("/MediaBox [0 0 " + X(h) + " " + X(l) + "]"), V.publish("putPage", {
                        pageNumber: t,
                        page: R[t]
                    }), Q("/Contents " + (q + 1) + " 0 R"), Q(">>"), Q("endobj"), n = R[t].join("\n"), K(), x) {
                        for (r = [], o = n.length; o--;) r[o] = n.charCodeAt(o);
                        a = c.from(n),
                        (s = new Deflater(6)).append(new Uint8Array(r)),
                        n = s.flush(),
                        ...
                        Q("<</Length " + n.length + " /Filter [/FlateDecode]>>")
                    } else Q("<</Length " + n.length + ">>");
                    Z(n),
                    Q("endobj")
                }
                P[1] = z,
                ...
                Q("<</Type /Pages");
                var p = "/Kids [";
                for (o = 0; o < B; o++) p += u[o] + " 0 R ";
                Q(p + "]"),
                Q("/Count " + B),
                Q(">>"),
                Q("endobj"),
                V.publish("postPutPages")
            },
            tt = function(t) {
                var e = 0 === Object.keys(t.metadata).length;
                if (t.id.slice(1) >= 14 && !e) {
                    var n = t.metadata.embedTTF(t.encoding, K, Q);
                    n ? t.objectNumber = n: delete F[t.id]
                } else t.objectNumber = K(),
                Q("<</BaseFont/" + t.postScriptName + "/Type/Font"),
                "string" == typeof t.encoding && Q("/Encoding/" + t.encoding),
                Q("/Subtype/Type1>>"),
                Q("endobj")
            },
            et = function() {
                for (var t in F) F.hasOwnProperty(t) && tt(F[t])
            },
            nt = function() {
                V.publish("putXobjectDict")
            },
            rt = function() {
                Q("/ProcSet [/PDF /Text /ImageB /ImageC /ImageI]"),
                Q("/Font <<");
                for (var t in F) F.hasOwnProperty(t) && Q("/" + t + " " + F[t].objectNumber + " 0 R");
                Q(">>"),
                Q("/XObject <<"),
                nt(),
                Q(">>")
            ...
            at = function(t, e, n, r) {
                var i = "F" + (Object.keys(F).length + 1).toString(10),
                o = F[i] = {
                    id: i,
                    postScriptName: t,
                    fontName: e,
            ...
            ct = function(t, e) {
                var n, r, i, o, s, a, c, h, l;
                if (e = e || {},
                i = e.sourceEncoding || "Unicode", s = e.outputEncoding, (e.autoencode || s) && F[p].metadata && F[p].metadata[i] && F[p].metadata[i].encoding && (o = F[p].metadata[i].encoding, !s && F[p].encoding && (s = F[p].encoding), !s && o.codePages && (s = o.codePages[0]), "string" == typeof s && (s = o[s]), s)) {
                    for (c = !1, a = [], n = 0, r = t.length; n < r; n++)(h = s[t.charCodeAt(n)]) ? a.push(String.fromCharCode(h)) : a.push(t[n]),
                ...
                for (a = e.noBOM ? [] : [254, 255], n = 0, r = t.length; n < r; n++) {
                    if (h = t.charCodeAt(n), (l = h >> 8) >> 8) throw new Error("Character at position " + n + " of string '" + t + "' exceeds 16bits. Cannot be encoded into UCS-2 BE");
                    a.push(l),
                    a.push(h - (l << 8))
                }
            ...
            lt = function() {
                Q("/Producer (jsPDF " + i.version + ")");
                for (var t in H) H.hasOwnProperty(t) && H[t] && Q("/" + t.substr(0, 1).toUpperCase() + t.substr(1) + " (" + ht(H[t]) + ")");
                var e = new Date,
                ...
                s = Math.abs(n % 60),
                a = [r, J(o), "'", J(s), "'"].join("");
                Q(["/CreationDate (D:", e.getFullYear(), J(e.getMonth() + 1), J(e.getDate()), J(e.getHours()), J(e.getMinutes()), J(e.getSeconds()), a, ")"].join(""))
            },
            ut = function() {
                switch (Q("/Type /Catalog"), Q("/Pages 1 0 R"), v || (v = "fullwidth"), v) {
                case "fullwidth":
                ...
                default:
                    var t = "" + v;
                    "%" === t.substr(t.length - 1) && (v = parseInt(v, 10) / 100),
                    "number" == typeof v && Q("/OpenAction [3 0 R /XYZ null null " + X(v) + "]")
                }
            ...
            ft = function(t, e) {
                ...
                if ("string" == typeof t) {
                    var r = t.toLowerCase();
                    s.hasOwnProperty(r) && (t = s[r][0] / f, e = s[r][1] / f)
                }
            ...
            gt = function(t) {
                t > 0 && t <= B && (R.splice(t, 1), j.splice(t, 1), g > --B && (g = B), this.setPage(g))
            },
            mt = function(t) {
                t > 0 && t <= B && (g = t, m = j[t].width, w = j[t].height)
            },
            wt = function(t, e) {
                var n, r;
                switch (t = void 0 !== t ? t: F[p].fontName, e = void 0 !== e ? e: F[p].fontStyle, r = t, void 0 !== t && (t = t.toLowerCase()), t) {
                case "sans-serif":
                case "verdana":
                case "arial":
                case "helvetica":
                ...
                return n || void 0 === (n = E.times[e]) && (n = E.times.normal),
                n
            },
            yt = function() {
                O = !1,
                ...
                var t, e = z,
                n = "0000000000";
                for (Q("xref"), Q("0 " + (q + 1)), Q(n + " 65535 f "), t = 1; t <= q; t++) {
                    var r = P[t];
                    Q("function" == typeof r ? (n + P[t]()).slice( - 10) + " 00000 n ": (n + P[t]).slice( - 10) + " 00000 n ")
                }
                return Q("trailer"),
                Q("<<"),
                pt(),
            ...
            bt = function() {
                for (var t = yt(), e = t.length, n = new ArrayBuffer(e), r = new Uint8Array(n); e--;) r[e] = t.charCodeAt(e);
                return n
            },
            xt = function() {
                return new Blob([bt()], {
            ...
            St = function(t) {
                return t.foo = function() {
                    try {
                        ...
                        var n = t.stack || "";~n.indexOf(" at ") && (n = n.split(" at ")[1]);
                ...
                var i = "dataur" === ("" + t).substr(0, 6) ? "data:application/pdf;base64," + btoa(yt()) : 0;
                switch (t) {
                case void 0:
                    return yt();
                case "save":
                    ...
                    r(xt(), n),
                    "function" == typeof r.unload && e.setTimeout && setTimeout(r.unload, 911);
                    break;
                case "arraybuffer":
                    return bt();
                case "blob":
                ...
                case "bloburi":
                case "bloburl":
                    return e.URL && e.URL.createObjectURL(xt()) || void 0;
                case "datauristring":
                case "dataurlstring":
                    return i;
            ...
            kt = function(t) {
                return ! 0 === Array.isArray(G) && G.indexOf(t) > -1
            };
            switch (c) {
            case "pt":
                f = 1;
            ...
            W.internal = {
                ...
                write: function(t) {
                    Q(1 === arguments.length ? t: Array.prototype.join.call(arguments, " "))
                },
            ...
            W.movePage = function(t, e) {
                var n, r, i, o;
                if (t > e) {
                    for (n = R[t], r = j[t], i = D[t], o = t; o > e; o--) R[o] = R[o - 1],
                    j[o] = j[o - 1],
                    D[o] = D[o - 1];
                    R[e] = n,
                    j[e] = r,
            ...
            W.setDisplayMode = function(t, e, n) {
                if (v = t, b = e, y = n, -1 === [void 0, null, "UseNone", "UseOutlines", "UseThumbs", "FullScreen"].indexOf(n)) throw new Error('Page mode must be one of UseNone, UseOutlines, UseThumbs, or FullScreen. "' + n + '" is not recognized.');
                return this
            },
            W.text = function(e, n, r, i) {
                function o(t) {
                    return t.toFixed(2)
                }
                var s, a = "",
                ...
                h = arguments[4],
                l = arguments[5];
                if ("number" == typeof e && (s = r, r = n, n = e, e = s), "string" == typeof e && (e = e.match(/[\n\r]/) ? e.split(/\r\n|\r|\n/g) : [e]), "object" === (void 0 === c ? "undefined": t(c)) && null !== c || ("string" == typeof h && (l = h, h = null), "string" == typeof c && (l = c, c = null), "number" == typeof c && (h = c, c = null), i = {
                    flags: c,
                    angle: h,
                    align: l
                }), h) {
                    h *= Math.PI / 180;
                    var u = Math.cos(h),
                    d = Math.sin(h); [o(u), o(d), o( - 1 * d), o(u)]
                }
                I && (a += I + " Tc\n");
                var g = -1,
                m = i.renderingMode || i.stroke,
                y = this.internal.getCurrentPageInfo().pageContext.usedRenderingMode || -1;
                switch (m) {
                case 0:
                case ! 1 : case "fill":
                    g = 0;
                ...
                if ( - 1 !== g ? a += g + " Tr\n": -1 !== y && (a += "0 Tr\n"), "[object Array]" !== Object.prototype.toString.call(e)) throw new Error('Type of text must be string or Array. "' + e + '" is not recognized.');
                for (var v = e.concat(), b = [], x = v.length, k = F[p], _ = "MacRomanEncoding" === k.encoding, q = p.slice(1) > 13; x--;) b.push(_ ? k.metadata.encode(k.metadata.subset, v.shift(), A) : function(t) {
                ...
                j = e.map(function(t) {
                    return this.getStringUnitWidth(t, D) * C / f
                },
                this),
                M = Math.max.apply(Math, j),
                U = _ ? "<": "(",
                N = _ ? ">": ")";
                if (l) {
                    if ("left" === l) P = n;
                    else if ("center" === l) O = n - M / 2,
                    n -= j[0] / 2;
                    else {
                        if ("right" !== l) throw new Error('Unrecognized alignment option, use "left", "center", "right".');
                        O = n - M,
                        n -= j[0]
                    }
                    for (e = b[0], B = 1, x = b.length; B < x; B++) E = M - j[B],
                    "center" === l && (E /= 2),
                    e += N + "Tj\n" + (O - P + E) + " -" + R + " Td " + U + b[B],
                    P = O + E
                }
                return e = U + b.join(N + " Tj\nT* " + U) + N,
                Q("BT\n/" + p + " " + C + " Tf\n" + C * T + " TL\n" + S + "\n" + a + o(n * f) + " " + o((w - r) * f) + " Td\n" + e + " Tj\nET"),
                this
            },
            W.lstext = function(t, e, n, r) {
                ...
                for (var i = 0,
                o = t.length; i < o; i++, e += r) this.text(t[i], e, n);
                return this
            },
            ...
            W.lines = function(t, e, n, r, i, o) {
                var s, a, c, h, l, u, p, g, m, y, v;
                for ("number" == typeof t && (d = n, n = e, e = t, t = d), r = r || [1, 1], Q(Y(e * f) + " " + Y((w - n) * f) + " m "), s = r[0], a = r[1], h = t.length, y = e, v = n, c = 0; c < h; c++) 2 === (l = t[c]).length ? (y = l[0] * s + y, v = l[1] * a + v, Q(Y(y * f) + " " + Y((w - v) * f) + " l")) : (u = l[0] * s + y, p = l[1] * a + v, g = l[2] * s + y, m = l[3] * a + v, y = l[4] * s + y, v = l[5] * a + v, Q(Y(u * f) + " " + Y((w - p) * f) + " " + Y(g * f) + " " + Y((w - m) * f) + " " + Y(y * f) + " " + Y((w - v) * f) + " c"));
                return o && Q(" h"),
                null !== i && Q(vt(i)),
                this
            },
            W.rect = function(t, e, n, r, i) {
                vt(i);
                return Q([X(t * f), X((w - e) * f), X(n * f), X( - r * f), "re"].join(" ")),
                null !== i && Q(vt(i)),
                this
            },
            ...
            W.ellipse = function(t, e, n, r, i) {
                ...
                return Q([X((t + n) * f), X((w - e) * f), "m", X((t + n) * f), X((w - (e - s)) * f), X((t + o) * f), X((w - (e - r)) * f), X(t * f), X((w - (e - r)) * f), "c"].join(" ")),
                Q([X((t - o) * f), X((w - (e - r)) * f), X((t - n) * f), X((w - (e - s)) * f), X((t - n) * f), X((w - e) * f), "c"].join(" ")),
                Q([X((t - n) * f), X((w - (e + s)) * f), X((t - o) * f), X((w - (e + r)) * f), X(t * f), X((w - (e + r)) * f), "c"].join(" ")),
                Q([X((t + o) * f), X((w - (e + r)) * f), X((t + n) * f), X((w - (e + s)) * f), X((t + n) * f), X((w - e) * f), "c"].join(" ")),
                null !== i && Q(vt(i)),
                this
            },
            ...
            W.getFontList = function() {
                ...
                for (t in E) if (E.hasOwnProperty(t)) {
                    r[t] = n = [];
                    for (e in E[t]) E[t].hasOwnProperty(e) && n.push(e)
                }
                return r
            },
            ...
            W.setFillColor = function(e, n, r, i) {
                var o;
                return void 0 === n || void 0 === i && e === n === r ? o = "string" == typeof e ? e + " g": X(e / 255) + " g": void 0 === i || "object" === (void 0 === i ? "undefined": t(i)) ? (o = "string" == typeof e ? [e, n, r, "rg"].join(" ") : [X(e / 255), X(n / 255), X(r / 255), "rg"].join(" "), i && 0 === i.a && (o = ["255", "255", "255", "rg"].join(" "))) : o = "string" == typeof e ? [e, n, r, i, "k"].join(" ") : [X(e), X(n), X(r), X(i), "k"].join(" "),
                Q(o),
                this
            },
            W.setTextColor = function(t, e, n) {
                ...
                return S = 0 === t && 0 === e && 0 === n || void 0 === e ? Y(t / 255) + " g": [Y(t / 255), Y(e / 255), Y(n / 255), "rg"].join(" "),
                this
            },
            ...
            for (var Ct in i.API) i.API.hasOwnProperty(Ct) && ("events" === Ct && i.API.events.length ?
            function(t, e) {
                var n, r, i;
                for (i = e.length - 1; - 1 !== i; i--) n = e[i][0],
                r = e[i][1],
                t.subscribe.apply(t, [n].concat("function" == typeof r ? [r] : r))
            } (V, i.API.events) : W[Ct] = i.API[Ct]);
            return function() {
                for (var t = [["Helvetica", "helvetica", "normal", "WinAnsiEncoding"], ["Helvetica-Bold", "helvetica", "bold", "WinAnsiEncoding"], ["Helvetica-Oblique", "helvetica", "italic", "WinAnsiEncoding"], ["Helvetica-BoldOblique", "helvetica", "bolditalic", "WinAnsiEncoding"], ["Courier", "courier", "normal", "WinAnsiEncoding"], ["Courier-Bold", "courier", "bold", "WinAnsiEncoding"], ["Courier-Oblique", "courier", "italic", "WinAnsiEncoding"], ["Courier-BoldOblique", "courier", "bolditalic", "WinAnsiEncoding"], ["Times-Roman", "times", "normal", "WinAnsiEncoding"], ["Times-Bold", "times", "bold", "WinAnsiEncoding"], ["Times-Italic", "times", "italic", "WinAnsiEncoding"], ["Times-BoldItalic", "times", "bolditalic", "WinAnsiEncoding"], ["ZapfDingbats", "zapfdingbats", void 0, "StandardEncoding"]], e = 0, n = t.length; e < n; e++) {
                    var r = at(t[e][0], t[e][1], t[e][2], t[e][3]),
                    i = t[e][0].split("-");
                    st(r, i[0], i[1] || "")
                }
                V.publish("addFonts", {
        ...
        i.version = "1.x-master",
        "function" == typeof define && define.amd ? define("jsPDF",
        function() {
            return i
        }) : "undefined" != typeof module && module.exports ? module.exports = i: e.jsPDF = i,
        i
    } ("undefined" != typeof self && self || "undefined" != typeof window && window || window));
    /**
 ...
 */
    (window.AcroForm = function(t) {
        ...
        o = function() {
            ...
            this.acroformPlugin.acroFormDictionaryRoot._eventID = this.internal.events.subscribe("postPutResources", h),
            ...
            for (var r in t) {
                ...
                if (i.appearanceStreamContent) {
                    ...
                    for (var c in i.appearanceStreamContent) {
                        ...
                        if (s += "/" + c + " ", s += "<< ", Object.keys(h).length >= 1 || Array.isArray(h)) for (var r in h)"function" == typeof(l = h[r]) && (l = l.call(this, i)),
                        s += "/" + r + " " + l + " ",
                        this.acroformPlugin.xForms.indexOf(l) >= 0 || this.acroformPlugin.xForms.push(l);
                        else {
                            var l = h;
                            "function" == typeof l && (l = l.call(this, i)),
                            s += "/" + r + " " + l + " \n",
                            this.acroformPlugin.xForms.indexOf(l) >= 0 || this.acroformPlugin.xForms.push(l)
                        }
                        s += " >>\n"
        ...
        t.addField = function(t) {
            return t instanceof n.TextField ? f.call(this, t) : t instanceof n.ChoiceField ? d.call(this, t) : t instanceof n.Button ? p.call(this, t) : t instanceof n.ChildClass ? a.call(this, t) : t && a.call(this, t),
            t.page = this.acroformPlugin.internal.getCurrentPageInfo().pageNumber,
            this
        };
        var p = function(t) { (t = t || new n.Field).FT = "/Btn";
            var e = t.Ff || 0;
            t.pushbutton && (e = n.internal.setBitPosition(e, 17), delete t.pushbutton),
            t.radio && (e = n.internal.setBitPosition(e, 16), delete t.radio),
            t.noToggleToOff && (e = n.internal.setBitPosition(e, 15)),
            t.Ff = e,
            a.call(this, t)
        },
        f = function(t) { (t = t || new n.Field).FT = "/Tx";
            var e = t.Ff || 0;
            t.multiline && (e |= 4096),
            t.password && (e |= 8192),
            t.fileSelect && (e |= 1 << 20),
        ...
        d = function(t) {
            ...
            e.multiSelect && this.internal.getPDFVersion() >= 1.4 && (r = n.internal.setBitPosition(r, 22), delete e.multiSelect),
            e.doNotSpellCheck && this.internal.getPDFVersion() >= 1.4 && (r = n.internal.setBitPosition(r, 23), delete e.doNotSpellCheck),
            e.Ff = r,
            a.call(this, e)
        }
    })(e.API);
    ...
    n.internal.calculateFontSpace = function(t, e, r) {
        var r = r || "helvetica",
        i = n.internal.calculateFontSpace.canvas || (n.internal.calculateFontSpace.canvas = document.createElement("canvas")); (a = i.getContext("2d")).save();
        var o = e + " " + r;
        a.font = o;
        var s = a.measureText(t);
        a.fontcolor = "black";
        var a = i.getContext("2d");
        return s.height = 1.5 * a.measureText("3").width,
        a.restore(),
        s
    },
    n.internal.calculateX = function(t, e, r, i) {
        ...
        t: for (;;) {
            var e = "";
            a--;
            var l = n.internal.calculateFontSpace("3", a + "px", r).height,
            u = t.multiline ? c - a: (c - l) / 2,
            p = -2,
            f = u += 2,
            d = 0,
            g = 0,
            ...
            m = n.internal.calculateFontSpace(s[0] + " ", a + "px", r).width;
            var w = "",
            y = 0;
            for (var v in s) {
                w = " " == (w += s[v] + " ").substr(w.length - 1) ? w.substr(0, w.length - 1) : w;
                var b = parseInt(v);
                m = n.internal.calculateFontSpace(w + " ", a + "px", r).width;
                var x = function(t, e, i) {
                    if (t + 1 < s.length) {
                        var o = e + " " + s[t + 1];
                        return n.internal.calculateFontSpace(o, i + "px", r).width <= h - 4
                    }
                    return ! 1
                } (b, w, a),
                S = v >= s.length - 1;
                if (!x || S) {
                    if (x || S) {
                        if (S) g = b;
                        else if (t.multiline && (l + 2) * (y + 2) + 2 > c) continue t
                    } else {
                        if (!t.multiline) continue t;
                        if ((l + 2) * (y + 2) + 2 > c) continue t;
                        g = b
                    }
                    for (var k = "",
                    C = d; C <= g; C++) k += s[C] + " ";
                    switch (k = " " == k.substr(k.length - 1) ? k.substr(0, k.length - 1) : k, m = n.internal.calculateFontSpace(k, a + "px", r).width, t.Q) {
                    case 2:
                        p = h - m - 2;
                        break;
                    case 1:
    ...
    e.API.addHTML = function(t, e, n, r, i) {
            ...
            if (r.format && (u = r.format), t.height > c && r.pagesplit) {
                var p = function() {
                    for (var r = 0;;) {
                        ...
                        var h = [o, e, r ? 0 : n, o.width / s, o.height / s, u, null, "SLOW"];
                        if (this.addImage.apply(this, h), (r += o.height) >= t.height) break;
                        this.addPage()
                    }
                    i(l, r, null, h)
                }.bind(this);
                if ("CANVAS" === t.nodeName) {
                    var f = new Image;
                    f.onload = p,
                    f.src = t.toDataURL("image/png"),
                    t = f
                } else p()
            } else {
                var d = Math.random().toString(35),
                g = [t, e, n, l, h, u, d, "SLOW"];
        ...
        if ("undefined" != typeof rasterizeHTML) {
            var h = "drawDocument";
            return "string" == typeof t && (h = /^http/.test(t) ? "drawURL": "drawHTML"),
            r.width = r.width || a * s,
            rasterizeHTML[h](t, void 0, r).then(function(t) {
    ...
    function(e) {
        ...
        r = function t(e) {
            ...
            if (e.n = n, r("<</Type /XObject"), r("/Subtype /Image"), r("/Width " + e.w), r("/Height " + e.h), e.cs === this.color_spaces.INDEXED ? r("/ColorSpace [/Indexed /DeviceRGB " + (e.pal.length / 3 - 1) + " " + ("smask" in e ? n + 2 : n + 1) + " 0 R]") : (r("/ColorSpace /" + e.cs), e.cs === this.color_spaces.DEVICE_CMYK && r("/Decode [1 0 1 0 1 0 1 0]")), r("/BitsPerComponent " + e.bpc), "f" in e && r("/Filter /" + e.f), "dp" in e && r("/DecodeParms <<" + e.dp + ">>"), "trns" in e && e.trns.constructor == Array) {
                for (var o = "",
                s = 0,
                a = e.trns.length; s < a; s++) o += e.trns[s] + " " + e.trns[s] + " ";
                r("/Mask [" + o + "]")
            }
        ...
        a = function() {
            ...
            this.internal.events.subscribe("putResources", i), this.internal.events.subscribe("putXobjectDict", o)),
            t
        },
        c = function(t) {
            var e = 0;
        ...
        d = function(e, n, r) {
            if ("IMG" === e.nodeName && e.hasAttribute("src")) {
                ...
                if (!r && 0 === i.indexOf("data:image/")) return i; ! n && /\.png(?:[?#].*)?$/i.test(i) && (n = "png")
            }
            if ("CANVAS" === e.nodeName) var o = e;
            else { (o = document.createElement("canvas")).width = e.clientWidth || e.width,
                o.height = e.clientHeight || e.height;
                var s = o.getContext("2d");
                if (!s) throw "addImage requires canvas to be supported by browser.";
                if (r) {
                    var a, c, h, l, u, p, f, d, g = Math.PI / 180;
                    "object" === (void 0 === r ? "undefined": t(r)) && (a = r.x, c = r.y, h = r.bg, r = r.angle),
                    d = r * g,
                    l = Math.abs(Math.cos(d)),
                    u = Math.abs(Math.sin(d)),
                    p = o.width,
                    f = o.height,
                    o.width = f * u + p * l,
                    o.height = f * l + p * u,
        ...
        w = function(t, e, n, r, i, o, s) {
            var a = m.call(this, n, r, i),
            c = this.internal.getCoordinateString,
            h = this.internal.getVerticalCoordinateString;
            n = a[0],
            r = a[1],
            s[o] = i,
            this.internal.write("q", c(n), "0 0", c(r), c(t), h(e + r), "cm /I" + i.i, "Do Q")
        };
        e.color_spaces = {
        ...
        e.binaryStringToUint8Array = function(t) {
            for (var e = t.length,
            n = new Uint8Array(e), r = 0; r < e; r++) n[r] = t.charCodeAt(r);
            return n
        },
        ...
        e.arrayBufferToBase64 = function(t) {
            ...
            a = new Uint8Array(t), c = a.byteLength, h = c % 3, l = c - h, u = 0; u < l; u += 3) e = (258048 & (i = a[u] << 16 | a[u + 1] << 8 | a[u + 2])) >> 12,
            n = (4032 & i) >> 6,
            r = 63 & i,
            o += s[(16515072 & i) >> 18] + s[e] + s[n] + s[r];
            return 1 == h ? (e = (3 & (i = a[l])) << 4, o += s[(252 & i) >> 2] + s[e] + "==") : 2 == h && (e = (1008 & (i = a[l] << 8 | a[l + 1])) >> 4, n = (15 & i) << 2, o += s[(64512 & i) >> 10] + s[e] + s[n] + "="),
            o
        },
        e.createImageInfo = function(t, e, n, r, i, o, s, a, c, h, l, u, p) {
            var f = {
                alias: a,
                w: e,
                h: n,
        ...
        e.addImage = function(e, r, i, o, m, y, v, b, x) {
            if ("string" != typeof r) {
                var S = y;
                y = m,
                m = o,
            ...
            if ("object" === (void 0 === e ? "undefined": t(e)) && !f(e) && "imageData" in e) {
                var k = e;
                e = k.imageData,
                r = k.format || r,
                i = k.x || i || 0,
                ...
                v = k.alias || v,
                b = k.compression || b,
                x = k.rotation || k.angle || x
            }
            if (isNaN(i) || isNaN(o)) throw console.error("jsPDF.addImage: Invalid coordinates", arguments),
            new Error("Invalid coordinates passed to jsPDF.addImage");
            var C, I = a.call(this);
            if (! (C = g(e, I))) {
                var A;
                if (f(e) && (e = d(e, r, x)), h(v) && (v = l(e)), !(C = g(v, I))) {
                    if (this.isString(e)) {
                        var T = this.extractInfoFromBase64DataURI(e);
                        T ? (r = T[2], e = atob(T[3])) : 137 === e.charCodeAt(0) && 80 === e.charCodeAt(1) && 78 === e.charCodeAt(2) && 71 === e.charCodeAt(3) && (r = "png")
                    }
                    if (r = (r || "JPEG").toLowerCase(), u(r)) throw new Error("addImage currently only supports formats " + n + ", not '" + r + "'");
                    if (p(r)) throw new Error("please ensure that the plugin for '" + r + "' support is added");
                    if (this.supportsArrayBuffer() && (e instanceof Uint8Array || (A = e, e = this.binaryStringToUint8Array(e))), !(C = this["process" + r.toUpperCase()](e, c(I), v, s(b), A))) throw new Error("An unkwown error occurred whilst processing the image")
                }
            }
            return w.call(this, i, o, m, y, C, C.i, I),
            this
        };
        var y = function(t) {
            var e, n, r;
            ...
            for (var i = 256 * t.charCodeAt(4) + t.charCodeAt(5), o = 4, s = t.length; o < s;) {
                if (o += i, 255 !== t.charCodeAt(o)) throw new Error("getJpegSize could not find the size of the image");
                if (192 === t.charCodeAt(o + 1) || 193 === t.charCodeAt(o + 1) || 194 === t.charCodeAt(o + 1) || 195 === t.charCodeAt(o + 1) || 196 === t.charCodeAt(o + 1) || 197 === t.charCodeAt(o + 1) || 198 === t.charCodeAt(o + 1) || 199 === t.charCodeAt(o + 1)) return n = 256 * t.charCodeAt(o + 5) + t.charCodeAt(o + 6),
        ...
        v = function(t) {
            ...
            for (var e, n, r, i, o = t.length,
            s = (t[4] << 8) + t[5], a = 4; a < o;) {
                if (a += s, e = b(t, a), s = (e[2] << 8) + e[3], (192 === e[1] || 194 === e[1]) && 255 === e[0] && s > 7) return e = b(t, a + 5),
                n = (e[2] << 8) + e[3],
                r = (e[0] << 8) + e[1],
                i = e[4],
                {
 ...
 */
    function(t) {
        ...
        e.API.events.push(["addPage",
        function(t) {
            this.annotationPlugin.annotations[t.pageNumber] = []
        }]),
        t.events.push(["putPage",
        function(t) {
            for (var e = this.annotationPlugin.annotations[t.pageNumber], r = !1, i = 0; i < e.length && !r; i++) switch ((h = e[i]).type) {
            case "link":
                if (n.notEmpty(h.options.url) || n.notEmpty(h.options.pageNumber)) {
                    r = !0;
                    break
                }
            case "reference":
            ...
            if (0 != r) {
                ...
                for (var o = this.annotationPlugin.f2,
                s = this.internal.scaleFactor,
                a = this.internal.pageSize.height,
                c = this.internal.getPageInfo(t.pageNumber), i = 0; i < e.length; i++) {
                    var h = e[i];
                    switch (h.type) {
                    case "reference":
                    ...
                    case "text":
                        ...
                        p = h.title || "Note";
                        w = "<</Type /Annot /Subtype /Text " + (d = "/Rect [" + o(h.bounds.x * s) + " " + o(a - (h.bounds.y + h.bounds.h) * s) + " " + o((h.bounds.x + h.bounds.w) * s) + " " + o((a - h.bounds.y) * s) + "] ") + "/Contents (" + h.contents + ")",
                        w += " /Popup " + u.objId + " 0 R",
                        w += " /P " + c.objId + " 0 R",
                        w += " /T (" + p + ") >>",
                        l.content = w;
                        var f = l.objId + " 0 R";
                        w = "<</Type /Annot /Subtype /Popup " + (d = "/Rect [" + o((h.bounds.x + 30) * s) + " " + o(a - (h.bounds.y + h.bounds.h) * s) + " " + o((h.bounds.x + h.bounds.w + 30) * s) + " " + o((a - h.bounds.y) * s) + "] ") + " /Parent " + f,
                        h.open && (w += " /Open true"),
                        w += " >>",
                        u.content = w,
                        ...
                        break;
                    case "freetext":
                        var d = "/Rect [" + o(h.bounds.x * s) + " " + o((a - h.bounds.y) * s) + " " + o(h.bounds.x + h.bounds.w * s) + " " + o(a - (h.bounds.y + h.bounds.h) * s) + "] ",
                        g = h.color || "#000000";
                        w = "<</Type /Annot /Subtype /FreeText " + d + "/Contents (" + h.contents + ")",
                    ...
                    case "link":
                        if (h.options.name) {
                            var m = this.annotations._nameMap[h.options.name];
                            h.options.pageNumber = m.page,
                            h.options.top = m.y
                        } else h.options.top || (h.options.top = 0);
                        var d = "/Rect [" + o(h.x * s) + " " + o((a - h.y) * s) + " " + o((h.x + h.w) * s) + " " + o((a - (h.y + h.h)) * s) + "] ",
                        w = "";
                        if (h.options.url) w = "<</Type /Annot /Subtype /Link " + d + "/Border [0 0 0] /A <</S /URI /URI (" + h.options.url + ") >>";
                        else if (h.options.pageNumber) switch (w = "<</Type /Annot /Subtype /Link " + d + "/Border [0 0 0] /Dest [" + (t = this.internal.getPageInfo(h.options.pageNumber)).objId + " 0 R", h.options.magFactor = h.options.magFactor || "XYZ", h.options.magFactor) {
                        case "Fit":
                            w += " /Fit]";
                            break;
                        case "FitH":
                            w += " /FitH " + h.options.top + "]";
                            break;
                        case "FitV":
                            h.options.left = h.options.left || 0,
                            w += " /FitV " + h.options.left + "]";
                            break;
                        case "XYZ":
                        default:
                            var y = o((a - h.options.top) * s);
                            h.options.left = h.options.left || 0,
                            void 0 === h.options.zoom && (h.options.zoom = 0),
                            w += " /XYZ " + h.options.left + " " + y + " " + h.options.zoom + "]"
                        }
    ...
    e.API.autoPrint = function() {
        ...
        this.internal.events.subscribe("putCatalog",
        function() {
 ...
 */
    function(t) {
        ...
        t.getTextDimensions = function(t) {
            ...
            var i, o; (o = document.createElement("font")).id = "jsPDFCell";
            try {
                o.style.fontStyle = r
            } catch(t) {
        ...
        t.cell = function(t, e, n, r, i, o, s) {
            var l = c(),
            u = !1;
            if (void 0 !== l.ln) if (l.ln === o) t = l.x + l.w,
            e = l.y;
            else {
                var p = this.margins || h;
                l.y + l.h + r + 13 >= this.internal.pageSize.height - p.bottom && (this.cellAddPage(), u = !0, this.printHeaders && this.tableHeaderRow && this.printHeaderRow(o, !0)),
                e = c().y + c().h,
                u && (e = 23)
            }
            if (void 0 !== i[0]) if (this.printingHeaderRow ? this.rect(t, e, n, r, "FD") : this.rect(t, e, n, r), "right" === s) {
                ...
                for (var f = 0; f < i.length; f++) {
                    var d = i[f],
                    g = this.getStringUnitWidth(d) * this.internal.getFontSize();
                    this.text(d, t + n - g - 3, e + this.internal.getLineHeight() * (f + 1))
                }
        ...
        t.table = function(e, n, r, i, a) {
            ...
            T = 12,
            _ = h;
            if (_.width = this.internal.pageSize.width, a && (!0 === a.autoSize && (I = !0), !1 === a.printHeaders && (A = !1), a.fontSize && (T = a.fontSize), a.css && void 0 !== a.css["font-size"] && (T = 16 * a.css["font-size"]), a.margins && (_ = a.margins)), this.lnMod = 0, o = {
                x: void 0,
                y: void 0,
                w: void 0,
                h: void 0,
            ...
            s = 1, this.printHeaders = A, this.margins = _, this.setFontSize(T), this.table_font_size = T, void 0 === i || null === i) v = Object.keys(r[0]);
            else if (i[0] && "string" != typeof i[0]) {
                for (l = 0, u = i.length; l < u; l += 1) c = i[l],
                v.push(c.name),
                b.push(c.prompt),
                S[c.name] = c.width * (19.049976 / 25.4)
            } else v = i;
            if (I) for (y = function(t) {
                return t[c]
            },
            l = 0, u = v.length; l < u; l += 1) {
                for (x[c = v[l]] = r.map(y), k.push(this.getTextDimensions(b[l] || c).w), g = 0, p = (d = x[c]).length; g < p; g += 1) f = d[g],
                k.push(this.getTextDimensions(f).w);
                S[c] = t.arrayMax(k),
                k = []
            }
            if (A) {
                q = this.calculateLineHeight(v, S, b.length ? b: v);
                for (l = 0, u = v.length; l < u; l += 1) c = v[l],
                C.push([e, n, S[c], q, String(b.length ? b[l] : c)]);
                this.setTableHeaderRow(C),
                this.printHeaderRow(1, !1)
            }
            for (l = 0, u = r.length; l < u; l += 1) {
                var q;
                for (m = r[l], q = this.calculateLineHeight(v, S, m), g = 0, w = v.length; g < w; g += 1) c = v[g],
                this.cell(e, n, S[c], q, m[c], l + 2, c.align)
            }
            return this.lastCellPos = o,
            this.table_x = e,
            this.table_y = n,
            this
        },
        ...
        t.printHeaderRow = function(t, e) {
            ...
            var l = [];
            for (o = 0, c = this.tableHeaderRow.length; o < c; o += 1) this.setFillColor(200, 200, 200),
            n = this.tableHeaderRow[o],
            e && (this.margins.top = 13, n[1] = this.margins && this.margins.top || 0, l.push(n)),
            r = [].concat(n),
    ...
    function(t) {
        ...
        t.context2d = {
            ...
            _getRGBA: function(t) {
                ...
                if (this.internal.rxTransparent.test(t)) e = 0,
                n = 0,
                r = 0,
                i = 0;
                else {
            ...
            fillText: function(t, e, n, r) {
                if (!this._isFillTransparent()) {
                    ...
                    if (this.ctx._clip_path.length > 0) {
                        var s; (s = window.outIntercept ? "group" === window.outIntercept.type ? window.outIntercept.stream: window.outIntercept: this.internal.getCurrentPage()).push("q");
                        var a = this.path;
                    ...
                    if (c < .01) this.pdf.text(t, e, this._getBaseline(n), null, o);
                        ...
                        var h = this.pdf.internal.getFontSize();
                        this.pdf.setFontSize(h * c),
                        this.pdf.text(t, e, this._getBaseline(n), null, o),
                        this.pdf.setFontSize(h)
                    }
            ...
            setFont: function(t) {
                ...
                if (null != (l = e.exec(t))) {
                    ...
                    var a, c = (p = s).toLowerCase().split(/\s*,\s*/);
                    a = -1 != c.indexOf("arial") ? "Arial": -1 != c.indexOf("verdana") ? "Verdana": -1 != c.indexOf("helvetica") ? "Helvetica": -1 != c.indexOf("sans-serif") ? "sans-serif": -1 != c.indexOf("fixed") ? "Fixed": -1 != c.indexOf("monospace") ? "Monospace": -1 != c.indexOf("terminal") ? "Terminal": -1 != c.indexOf("courier") ? "Courier": -1 != c.indexOf("times") ? "Times": -1 != c.indexOf("cursive") ? "Cursive": -1 != c.indexOf("fantasy") ? "Fantasy": (c.indexOf("serif"), "Serif");
                    var h;
                    h = "bold" === r ? "bold": "normal",
                    this.pdf.setFont(a, h)
                } else {
                    var l = (e = /\s*(\d+)(pt|px|em)\s+([\w "]+)\s*([\w "]+)?/).exec(t);
                    if (null != l) {
                        var u = l[1],
                        p = l[3]; (h = l[4]) || (h = "normal"),
                        u = "em" === o ? Math.floor(parseFloat(i) * this.pdf.getFontSize()) : Math.floor(parseFloat(u)),
                        this.pdf.setFontSize(u),
                        this.pdf.setFont(p, h)
                    }
                }
            },
            ...
            _page: function(t) {
                if (this.pageWrapYEnabled) {
                    ...
                    for (var e = 0,
                    n = 0,
                    r = 0; r < this.pageBreaks.length; r++) if (t >= this.pageBreaks[r]) {
                        e++,
                        0 === this.lastBreak && n++;
                        var i = this.pageBreaks[r] - this.lastBreak;
                        this.lastBreak = this.pageBreaks[r],
                        n += o = Math.floor(i / this.pageWrapY)
                    }
                    if (0 === this.lastBreak) {
            ...
            drawImage: function(t, e, n, r, i, o, s, a, c) {
                ...
                e = this._wrapX(e),
                n = this._wrapY(n);
                var h, l = this._matrix_map_rect(this.ctx._transform, {
                    x: e,
                    y: n,
                    w: r,
                    h: i
                ...
                h = null != u ? u[1] : "png",
                this.pdf.addImage(t, h, l.x, l.y, l.w, l.h)
            },
            ...
            stroke: function() {
                if (this.ctx._clip_path.length > 0) {
                    var t; (t = window.outIntercept ? "group" === window.outIntercept.type ? window.outIntercept.stream: window.outIntercept: this.internal.getCurrentPage()).push("q");
                    var e = this.path;
                    this.path = this.ctx._clip_path,
                    this.ctx._clip_path = [],
                    this._stroke(!0),
                ...
                if (t || !this._isStrokeTransparent()) {
                    for (var e = [], n = this.path, r = 0; r < n.length; r++) {
                        ...
                        case "mt":
                            ...
                            break;
                        case "lt":
                            u = [i.x - n[r - 1].x, i.y - n[r - 1].y];
                            e[e.length - 1].deltas.push(u),
                            e[e.length - 1].abs.push(i);
                            break;
                        case "bct":
                            u = [i.x1 - n[r - 1].x, i.y1 - n[r - 1].y, i.x2 - n[r - 1].x, i.y2 - n[r - 1].y, i.x - n[r - 1].x, i.y - n[r - 1].y];
                            e[e.length - 1].deltas.push(u);
                            break;
                        case "qct":
                            ...
                            h = i.x,
                            l = i.y,
                            u = [o - n[r - 1].x, s - n[r - 1].y, a - n[r - 1].x, c - n[r - 1].y, h - n[r - 1].x, l - n[r - 1].y];
                            e[e.length - 1].deltas.push(u);
                            break;
                        case "arc":
                            0 == e.length && e.push({
                    ...
                    for (r = 0; r < e.length; r++) {
                        var p;
                        if (p = r == e.length - 1 ? "s": null, e[r].arc) for (var f = e[r].abs, d = 0; d < f.length; d++) {
                            var g = f[d],
                            m = 360 * g.startAngle / (2 * Math.PI),
                            w = 360 * g.endAngle / (2 * Math.PI),
                            y = g.x,
                            v = g.y;
                            this.internal.arc2(this, y, v, g.radius, m, w, g.anticlockwise, p, t)
                        } else {
                            var y = e[r].start.x,
                            v = e[r].start.y;
                            t ? (this.pdf.lines(e[r].deltas, y, v, null, null), this.pdf.clip_fixed()) : this.pdf.lines(e[r].deltas, y, v, null, p)
                        }
                    }
                }
            },
            ...
            fill: function(t) {
                if (this.ctx._clip_path.length > 0) {
                    var e; (e = window.outIntercept ? "group" === window.outIntercept.type ? window.outIntercept.stream: window.outIntercept: this.internal.getCurrentPage()).push("q");
                    var n = this.path;
                    this.path = this.ctx._clip_path,
                    this.ctx._clip_path = [],
                    this._fill(t, !0),
            ...
            _fill: function(t, e) {
                if (!this._isFillTransparent()) {
                    ...
                    case "destination-out":
                        ...
                        c.push(">>");
                        f = "MASK" + c.objId;
                        this.pdf.internal.addGraphicsState(f, c.objId);
                        var h = "/" + f + " gs";
                        r.splice(0, 0, "q"),
                        r.splice(1, 0, h),
                        r.push("Q"),
                    ...
                    if (this.ctx._fillOpacity < 1 && (u = this.ctx._fillOpacity), i) {
                        var p = this.pdf.internal.newObject2();
                        p.push("<</Type /ExtGState"),
                        p.push("/CA " + u),
                        p.push("/ca " + u),
                        p.push(">>");
                        var f = "GS_O_" + p.objId;
                        this.pdf.internal.addGraphicsState(f, p.objId),
                        this.pdf.internal.out("/" + f + " gs")
                    }
                    for (var d = this.path,
                    g = 0; g < d.length; g++) {
                        var m = d[g];
                        ...
                        case "mt":
                            ...
                            break;
                        case "lt":
                            k = [m.x - d[g - 1].x, m.y - d[g - 1].y];
                            o[o.length - 1].deltas.push(k),
                            o[o.length - 1].abs.push(m);
                            break;
                        case "bct":
                            k = [m.x1 - d[g - 1].x, m.y1 - d[g - 1].y, m.x2 - d[g - 1].x, m.y2 - d[g - 1].y, m.x - d[g - 1].x, m.y - d[g - 1].y];
                            o[o.length - 1].deltas.push(k);
                            break;
                        case "qct":
                            var w = d[g - 1].x + 2 / 3 * (m.x1 - d[g - 1].x),
                            y = d[g - 1].y + 2 / 3 * (m.y1 - d[g - 1].y),
                            v = m.x + 2 / 3 * (m.x1 - m.x),
                            b = m.y + 2 / 3 * (m.y1 - m.y),
                            x = m.x,
                            S = m.y,
                            k = [w - d[g - 1].x, y - d[g - 1].y, v - d[g - 1].x, b - d[g - 1].y, x - d[g - 1].x, S - d[g - 1].y];
                            o[o.length - 1].deltas.push(k);
                            break;
                        case "arc":
                            0 === o.length && o.push({
                    ...
                    for (g = 0; g < o.length; g++) {
                        var C;
                        if (g == o.length - 1 ? (C = "f", "evenodd" === t && (C += "*")) : C = null, o[g].close) this.pdf.internal.out("h"),
                        this.pdf.internal.out("f");
                        else if (o[g].arc) {
                            o[g].start && this.internal.move2(this, o[g].start.x, o[g].start.y);
                            for (var I = o[g].abs, A = 0; A < I.length; A++) {
                                var T = I[A];
                                if (void 0 !== T.startAngle) {
                                    var _ = 360 * T.startAngle / (2 * Math.PI),
                                    q = 360 * T.endAngle / (2 * Math.PI),
                                    O = T.x,
                                    P = T.y;
                                    if (0 === A && this.internal.move2(this, O, P), this.internal.arc2(this, O, P, T.radius, _, q, T.anticlockwise, null, e), A === I.length - 1 && o[g].start) {
                                        var O = o[g].start.x,
                                        P = o[g].start.y;
                                        this.internal.line2(n, O, P)
                                    }
                                } else this.internal.line2(n, T.x, T.y)
                            }
                        } else {
                            var O = o[g].start.x,
                            P = o[g].start.y;
                            e ? (this.pdf.lines(o[g].deltas, O, P, null, null), this.pdf.clip_fixed()) : this.pdf.lines(o[g].deltas, O, P, null, C)
                        }
                    }
        ...
        n.internal.arc = function(t, e, n, r, i, o, s, a) {
            for (var c = this.pdf.internal.scaleFactor,
            h = this.pdf.internal.pageSize.height,
            l = this.pdf.internal.f2,
            u = i * (Math.PI / 180), p = o * (Math.PI / 180), f = this.createArc(r, u, p, s), d = 0; d < f.length; d++) {
                var g = f[d];
                0 === d ? this.pdf.internal.out([l((g.x1 + e) * c), l((h - (g.y1 + n)) * c), "m", l((g.x2 + e) * c), l((h - (g.y2 + n)) * c), l((g.x3 + e) * c), l((h - (g.y3 + n)) * c), l((g.x4 + e) * c), l((h - (g.y4 + n)) * c), "c"].join(" ")) : this.pdf.internal.out([l((g.x2 + e) * c), l((h - (g.y2 + n)) * c), l((g.x3 + e) * c), l((h - (g.y3 + n)) * c), l((g.x4 + e) * c), l((h - (g.y4 + n)) * c), "c"].join(" ")),
                t._lastPoint = {
                    x: e,
                    y: n
                }
        ...
        n.internal.arc2 = function(t, e, n, r, i, o, s, a, c) {
            var h = e,
            l = n;
            c ? (this.arc(t, h, l, r, i, o, s, null), this.pdf.clip_fixed()) : this.arc(t, h, l, r, i, o, s, a)
        },
        ...
        n.internal.createArc = function(t, e, n, r) {
            ...
            var a = Math.abs(n - e);
            a < i && r && (a = i - a);
            for (var c = [], h = r ? -1 : 1, l = s; a > 1e-5;) {
                var u = l + h * Math.min(a, o);
                c.push(this.createSmallArc(t, l, u)),
                a -= Math.abs(u - l),
                l = u
            }
            return c
        ...
        n.internal.createSmallArc = function(t, e, n) {
            ...
            c = s * s + a * a,
            h = c + s * i + a * o,
            l = 4 / 3 * (Math.sqrt(2 * c * h) - h) / (s * o - a * i),
            u = s - l * a,
            p = a + l * s,
            f = u,
            d = -p,
 ...
 */
    function(e) {
        var n, r, i, o, s, a, c, h, l, u, p, f, d, g, m, w, y, v, b, x;
        n = function() {
            function t() {}
            return function(e) {
        ...
        u = function(t) {
            var e, n, r, i, o, s, a;
            for (n = 0, r = t.length, e = void 0, i = !1, s = !1; ! i && n !== r;)(e = t[n] = t[n].trimLeft()) && (i = !0),
            n++;
            for (n = r - 1; r && !s && -1 !== n;)(e = t[n] = t[n].trimRight()) && (s = !0),
            n--;
            for (o = /\s+$/g, a = !0, n = 0; n !== r;)"\u2028" != t[n] && (e = t[n].replace(/\s+/g, " "), a && (e = e.trimLeft()), e && (a = o.test(e)), t[n] = e),
            n++;
            return t
        },
        f = function(t) {
            var e, n, r;
            for (e = void 0, n = (r = t.split(",")).shift(); ! e && n;) e = i[n.trim().toLowerCase()],
            n = r.shift();
            return e
        },
        d = function(t) { (t = "auto" === t ? "0px": t).indexOf("em") > -1 && !isNaN(Number(t.replace("em", ""))) && (t = 18.719 * Number(t.replace("em", "")) + "px"),
        ...
        m = function(t, e, n) {
            var r, i, o, s, a;
            if (o = !1, i = void 0, s = void 0, r = n["#" + t.id]) if ("function" == typeof r) o = r(t, e);
            else for (i = 0, s = r.length; ! o && i !== s;) o = r[i](t, e),
            i++;
            if (r = n[t.nodeName], !o && r) if ("function" == typeof r) o = r(t, e);
            else for (i = 0, s = r.length; ! o && i !== s;) o = r[i](t, e),
            i++;
            for (a = t.className ? t.className.split(" ") : [], i = 0; i < a.length; i++) if (r = n["." + a[i]], !o && r) if ("function" == typeof r) o = r(t, e);
            else for (i = 0, s = r.length; ! o && i !== s;) o = r[i](t, e),
            i++;
            return o
        },
        x = function(t, e) {
            var n, r, i, o, s, a, c, h, l;
            for (n = [], r = [], i = 0, l = t.rows[0].cells.length, c = t.clientWidth; i < l;) h = t.rows[0].cells[i],
            r[i] = {
                name: h.textContent.toLowerCase().replace(/\s+/g, ""),
                prompt: h.textContent.replace(/\r?\n/g, ""),
                width: h.clientWidth / c * e.pdf.internal.pageSize.width
            },
            i++;
            for (i = 1; i < t.rows.length;) {
                for (a = t.rows[i], s = {},
                o = 0; o < a.cells.length;) s[r[o].name] = a.cells[o].textContent.replace(/\r?\n/g, ""),
                o++;
                n.push(s),
                i++
            }
        ...
        r = function(e, i, o) {
            var s, a, c, h, u, p, f, d;
            for (a = e.childNodes, s = void 0, (u = "block" === (c = l(e)).display) && (i.setBlockBoundary(), i.setBlockStyle(c)), h = 0, p = a.length; h < p;) {
                if ("object" === (void 0 === (s = a[h]) ? "undefined": t(s))) {
                    if (i.executeWatchFunctions(s), 1 === s.nodeType && "HEADER" === s.nodeName) {
                        var g = s,
                        y = i.pdf.margins_doc.top;
                        i.pdf.internal.events.subscribe("addPage",
                        function(t) {
                            i.y = y,
                            r(g, i, o),
                    ...
                    if (8 === s.nodeType && "#comment" === s.nodeName)~s.textContent.indexOf("ADD_PAGE") && (i.pdf.addPage(), i.y = i.pdf.margins_doc.top);
                    else if (1 !== s.nodeType || S[s.nodeName]) if (3 === s.nodeType) {
                        var v = s.nodeValue;
                        if (s.nodeValue && "LI" === s.parentNode.nodeName) if ("OL" === s.parentNode.parentNode.nodeName) v = k+++". " + v;
                        else {
                            var b = c["font-size"],
                            C = (3 - .75 * b) * i.pdf.internal.scaleFactor,
                            I = .75 * b * i.pdf.internal.scaleFactor,
                            A = 1.74 * b / i.pdf.internal.scaleFactor;
                            d = function(t, e) {
                                this.pdf.circle(t + C, e + I, A, "FD")
                            }
                        }
                        ...
                        if (T) {
                            ...
                            var q = l(s),
                            O = i.x,
                            P = 12 / i.pdf.internal.scaleFactor,
                            F = (q["margin-left"] + q["padding-left"]) * P,
                            E = (q["margin-right"] + q["padding-right"]) * P,
                            B = (q["margin-top"] + q["padding-top"]) * P,
                            R = (q["margin-bottom"] + q["padding-bottom"]) * P;
                            void 0 !== q.float && "right" === q.float ? O += i.settings.width - s.width - E: O += F,
                            i.pdf.addImage(T, O, i.y + B, s.width, s.height),
                            T = void 0,
                            "right" === q.float || "left" === q.float ? (i.watchFunctions.push(function(t, e, n, r) {
                                return i.y >= e ? (i.x += t, i.settings.width += n, !0) : !!(r && 1 === r.nodeType && !S[r.nodeName] && i.x + r.width > i.pdf.margins_doc.left + i.pdf.margins_doc.width) && (i.x += t, i.y = e, i.settings.width += n, !0)
                            }.bind(this, "left" === q.float ? -s.width - F - E: 0, i.y + s.height + B + R, s.width)), i.watchFunctions.push(function(t, e, n) {
                                return ! (i.y < t && e === i.pdf.internal.getNumberOfPages()) || 1 === n.nodeType && "both" === l(n).clear && (i.y = t, !0)
                            }.bind(this, i.y + s.height, i.pdf.internal.getNumberOfPages())), i.settings.width -= s.width + F + E, "left" === q.float && (i.x += s.width + F + E)) : i.y += s.height + B + R
                        } else if ("TABLE" === s.nodeName) f = x(s, i),
                        i.y += 10,
                        i.pdf.table(i.x, i.y, f.rows, f.headers, {
                            autoSize: !1,
                        ...
                        else if ("OL" === s.nodeName || "UL" === s.nodeName) k = 1,
                        m(s, i, o) || r(s, i, o),
                        i.y += 10;
            ...
            if (o.outY = i.y, u) return i.setBlockBoundary(d)
        },
        w = {},
        y = function(t, e, n, r) {
            function i() {
            ...
            for (var o, s = t.getElementsByTagName("img"), a = s.length, c = 0; a--;) !
            function(t, n, r) {
                if (t) {
                    var s = new Image;
                    o = ++c,
        ...
        b = function(t, e, n, i, o, s) {
            ...
            var a, c = new p(t, n, i, o);
            return y.call(this, e, c, o.elementHandlers,
            function(t) {
        ...
        p.prototype.splitFragmentsIntoLines = function(t, e) {
            var r, i, o, s, a, c, h, l, u, p, f, d, g, m;
            for (12, p = this.pdf.internal.scaleFactor, s = {},
            i = void 0, u = void 0, o = void 0, a = void 0, m = void 0, l = void 0, h = void 0, c = void 0, d = [f = []], r = 0, g = this.settings.width; t.length;) if (a = t.shift(), m = e.shift(), a) if (i = m["font-family"], u = m["font-style"], (o = s[i + u]) || (o = this.pdf.internal.getFont(i, u).metadata.Unicode, s[i + u] = o), l = {
                widths: o.widths,
                kerning: o.kerning,
                fontSize: 12 * m["font-size"],
                textIndent: r
            },
            h = this.pdf.getStringUnitWidth(a, l) * l.fontSize / p, "\u2028" == a) f = [],
            d.push(f);
            else if (r + h > g) {
                for (c = this.pdf.splitTextToSize(a, g, l), f.push([c.shift(), m]); c.length;) f = [[c.shift(), m]],
                d.push(f);
                r = this.pdf.getStringUnitWidth(f[0][0], l) * l.fontSize / p
            } else f.push([a, m]),
            r += h;
            if (void 0 !== m["text-align"] && ("center" === m["text-align"] || "right" === m["text-align"] || "justify" === m["text-align"])) for (var w = 0; w < d.length; ++w) {
                var y = this.pdf.getStringUnitWidth(d[w][0][0], l) * l.fontSize / p;
                w > 0 && (d[w][0][1] = n(d[w][0][1]));
                var v = g - y;
                if ("right" === m["text-align"]) d[w][0][1]["margin-left"] = v;
                else if ("center" === m["text-align"]) d[w][0][1]["margin-left"] = v / 2;
                else if ("justify" === m["text-align"]) {
                    var b = d[w][0][0].split(" ").length - 1;
                    d[w][0][1]["word-spacing"] = v / b,
        ...
        p.prototype.RenderTextFragment = function(t, e) {
            var n, r;
            r = 0,
            this.pdf.internal.pageSize.height - this.pdf.margins_doc.bottom < this.y + this.pdf.internal.getFontSize() && (this.pdf.internal.write("ET", "Q"), this.pdf.addPage(), this.y = this.pdf.margins_doc.top, this.pdf.internal.write("q", "BT 0 g", this.pdf.internal.getCoordinateString(this.x), this.pdf.internal.getVerticalCoordinateString(this.y), e.color, "Td"), r = Math.max(r, e["line-height"], e["font-size"]), this.pdf.internal.write(0, ( - 12 * r).toFixed(2), "Td")),
        ...
        p.prototype.getPdfColor = function(t) {
            ...
            if (null != i ? (e = parseInt(i[1]), n = parseInt(i[2]), r = parseInt(i[3])) : ("#" != t.charAt(0) && ((t = CssColors.colorNameToHex(t)) || (t = "#000000")), e = t.substring(1, 3), e = parseInt(e, 16), n = t.substring(3, 5), n = parseInt(n, 16), r = t.substring(5, 7), r = parseInt(r, 16)), "string" == typeof e && /^#[0-9A-Fa-f]{6}$/.test(e)) {
        ...
        p.prototype.renderParagraph = function(t) {
            var e, n, r, i, o, s, a, c, h, l, p, f, d;
            if (r = u(this.paragraph.text), f = this.paragraph.style, e = this.paragraph.blockstyle, this.paragraph = {
                text: [],
                style: [],
                blockstyle: {},
                priorblockstyle: e
            ...
            r.join("").trim()) {
                a = this.splitFragmentsIntoLines(r, f),
                s = void 0,
                c = void 0,
                12,
                n = 12 / this.pdf.internal.scaleFactor,
                this.priorMarginBottom = this.priorMarginBottom || 0,
                p = (Math.max((e["margin-top"] || 0) - this.priorMarginBottom, 0) + (e["padding-top"] || 0)) * n,
                l = ((e["margin-bottom"] || 0) + (e["padding-bottom"] || 0)) * n,
                this.priorMarginBottom = e["margin-bottom"] || 0,
                "always" === e["page-break-before"] && (this.pdf.addPage(), this.y = 0, p = ((e["margin-top"] || 0) + (e["padding-top"] || 0)) * n),
                ...
                for (var g = 0; a.length;) {
                    for (c = 0, i = 0, o = (s = a.shift()).length; i !== o;) s[i][0].trim() && (c = Math.max(c, s[i][1]["line-height"], s[i][1]["font-size"]), d = 7 * s[i][1]["font-size"]),
                    i++;
                    var m = 0,
                    w = 0;
                    for (void 0 !== s[0][1]["margin-left"] && s[0][1]["margin-left"] > 0 && (m = (w = this.pdf.internal.getCoordinateString(s[0][1]["margin-left"])) - g, g = w), h(m + Math.max(e["margin-left"] || 0, 0) * n, ( - 12 * c).toFixed(2), "Td"), i = 0, o = s.length; i !== o;) s[i][0] && this.RenderTextFragment(s[i][0], s[i][1]),
                    i++;
                    if (this.y += c * n, this.executeWatchFunctions(s[0][1]) && a.length > 0) {
                        ...
                        a.forEach(function(t) {
                            for (var e = 0,
                            n = t.length; e !== n;) t[e][0] && (y.push(t[e][0] + " "), v.push(t[e][1])),
                            ++e
                        }),
                        a = this.splitFragmentsIntoLines(u(y), v),
                        h("ET", "Q"),
                        h("q", "BT 0 g", this.pdf.internal.getCoordinateString(this.x), this.pdf.internal.getVerticalCoordinateString(this.y), "Td")
                    }
                }
                return t && "function" == typeof t && t.call(this, this.x - 9, this.y - d / 2),
                h("ET", "Q"),
                this.y += l
            }
        },
    ...
    function(t) {
        ...
        e.API.addJS = function(t) {
            ...
            function(t) {
                ...
                this.internal.write("<< /Names [(EmbeddedJS) " + (n + 1) + " 0 R] >>", "endobj"),
                r = this.internal.newObject(),
                this.internal.write("<< /S /JavaScript /JS (", i, ") >>", "endobj")
            }),
            this.internal.events.subscribe("putCatalog",
            function() {
    ...
    function(t) {
        ...
        function() {
            ...
            if (this.outline.createNamedDestinations) {
                for (var a = this.internal.pages.length,
                c = [], r = 0; r < a; r++) {
        ...
        function() {
            ...
            t.outline.count_r = function(t, e) {
                for (var n = 0; n < e.children.length; n++) t.count++,
 ...
 */
    function(t) {
        ...
        i = function(e, n, r, i) {
            ...
            e = c(e, n, r, h);
            var d = new Uint8Array(s(o)),
            g = a(e),
            m = new Deflater(o),
            w = m.append(e),
            y = m.flush(),
            v = d.length + w.length + y.length,
            b = new Uint8Array(v + 4);
            return b.set(d),
            b.set(w, d.length),
            b.set(y, d.length + w.length),
            b[v++] = g >>> 24 & 255,
            b[v++] = g >>> 16 & 255,
            b[v++] = g >>> 8 & 255,
            b[v++] = 255 & g,
        ...
        c = function(t, e, n, r) {
            for (var i, o, s, a = t.length / e,
            c = new Uint8Array(t.length + a), h = g(), l = 0; l < a; l++) {
                if (s = l * e, i = t.subarray(s, s + e), r) c.set(r(i, n, o), s + l);
                else {
                    for (var u = 0,
                    p = h.length,
                    f = []; u < p; u++) f[u] = h[u](i, n, o);
                    var d = m(f.concat());
                    c.set(f[d], s + l)
                }
                o = i
        ...
        m = function(t) {
            for (var e, n, r, i = 0,
            o = t.length; i < o;)((e = w(t[i].slice(1))) < n || !n) && (n = e, r = i),
            i++;
            return r
        },
        w = function(t) {
        ...
        t.processPNG = function(t, r, o, s, a) {
            var c, h, l, u, p, f, d = this.color_spaces.DEVICE_RGB,
            ...
            if (this.isArrayBuffer(t) && (t = new Uint8Array(t)), this.isArrayBufferView(t)) {
                ...
                if (c = new PNG(t), t = c.imgData, m = c.bits, d = c.colorSpace, u = c.colors, -1 !== [4, 6].indexOf(c.colorType)) {
                    if (8 === c.bits) for (var w, v = (O = 32 == c.pixelBitlength ? new Uint32Array(c.decodePixels().buffer) : 16 == c.pixelBitlength ? new Uint16Array(c.decodePixels().buffer) : new Uint8Array(c.decodePixels().buffer)).length, b = new Uint8Array(v * c.colors), x = new Uint8Array(v), S = c.pixelBitlength - c.bits, k = 0, C = 0; k < v; k++) {
                        for (I = O[k], w = 0; w < S;) b[C++] = I >>> w & 255,
                        w += c.bits;
                        x[k] = I >>> w & 255
                    }
                    if (16 === c.bits) {
                        for (var I, v = (O = new Uint32Array(c.decodePixels().buffer)).length, b = new Uint8Array(v * (32 / c.pixelBitlength) * c.colors), x = new Uint8Array(v * (32 / c.pixelBitlength)), A = c.colors > 1, k = 0, C = 0, T = 0; k < v;) I = O[k++],
                        b[C++] = I >>> 0 & 255,
                        A && (b[C++] = I >>> 16 & 255, I = O[k++], b[C++] = I >>> 0 & 255),
                        x[T++] = I >>> 16 & 255;
                        m = 8
                    }
                    n(s) ? (t = i(b, c.width * c.colors, c.colors, s), f = i(x, c.width, 1, s)) : (t = b, f = x, g = null)
                }
                if (3 === c.colorType && (d = this.color_spaces.INDEXED, p = c.palette, c.transparency.indexed)) {
                    for (var _ = c.transparency.indexed,
                    q = 0,
                    k = 0,
                    v = _.length; k < v; ++k) q += _[k];
                    if ((q /= 255) === v - 1 && -1 !== _.indexOf(0)) l = [_.indexOf(0)];
                    else if (q !== v) {
                        for (var O = c.decodePixels(), x = new Uint8Array(O.length), k = 0, v = O.length; k < v; k++) x[k] = _[O[k]];
                        f = i(x, c.width, 1)
                    }
                }
                var P = y(s);
                return h = g === this.decode.FLATE_DECODE ? "/Predictor " + P + " /Colors " + u + " /BitsPerComponent " + m + " /Columns " + c.width: "/Colors " + u + " /BitsPerComponent " + m + " /Columns " + c.width,
                ...
                this.createImageInfo(t, c.width, c.height, d, m, g, r, o, h, l, p, f, P)
            }
 ...
 */
    function(t) {
        var e = t.getCharWidthsArray = function(t, e) {
            e || (e = {});
            var n, r = 0 !== Object.keys(this.internal.getFont().metadata).length,
            i = t.length,
            o = [];
            if (this.internal.getFont().id.slice(1) >= 14 && r) {
                var s = this.internal.getFontSize(),
                a = this.internal.getCharSpace();
                for (n = 0; n < i; n++) o.push(this.internal.getFont().metadata.widthOfString(t[n], s, a) / s)
            } else {
                var c = e.widths ? e.widths: this.internal.getFont().metadata.Unicode.widths,
                h = c.fof ? c.fof: 1,
                l = e.kerning ? e.kerning: this.internal.getFont().metadata.Unicode.kerning,
                u = l.fof ? l.fof: 1,
                p = 0,
                f = 0,
                d = c[0] || h;
                for (n = 0; n < i; n++) p = t.charCodeAt(n),
                o.push((c[p] || d) / h + (l[p] && l[p][f] || 0) / u),
                f = p
            }
            return o
        },
        ...
        i = function(t, e, n, r) {
            for (var i = [], o = 0, s = t.length, a = 0; o !== s && a + e[o] < n;) a += e[o],
            o++;
            i.push(t.slice(0, o));
            var c = o;
            for (a = 0; o !== s;) a + e[o] > r && (i.push(t.slice(c, o)), a = 0, c = o),
            a += e[o],
            o++;
        ...
        o = function(t, o, s) {
            ...
            v = t.split(" "),
            b = e.call(this, " ", s)[0];
            if (p = -1 === s.lineIndent ? v[0].length + 2 : s.lineIndent || 0) {
                var x = Array(p).join(" "),
                S = [];
                v.map(function(t) { (t = t.split(/\s*\n/)).length > 1 ? S = S.concat(t.map(function(t, e) {
                        return (e && t.length ? "\n": "") + t
                    })) : S.push(t[0])
                }),
                v = S,
            ...
            for (h = 0, l = v.length; h < l; h++) {
                var k = 0;
                if (a = v[h], p && "\n" === a[0] && (a = a.substr(1), k = 1), c = e.call(this, a, s), y = n(c), m + w + y > o || k) {
                    if (y > o) {
                        for (u = i(a, c, o - (m + w), o), d.push(u.shift()), d = [u.pop()]; u.length;) g.push([u.shift()]);
                        y = n(c.slice(a.length - d[0].length))
                    } else d = [a];
                    g.push(d),
                    m = y + p,
                    w = b
        ...
        t.splitTextToSize = function(t, e, n) {
            ...
            var c, h, l = [];
            for (c = 0, h = r.length; c < h; c++) l = l.concat(o.call(this, r[c], a, s));
            return l
        }
    } (e.API),
    /** @preserve 
...
*/
    function(t) {
        var e = function(t) {
            for (var e = {},
            n = 0; n < "klmnopqrstuvwxyz".length; n++) e["klmnopqrstuvwxyz" [n]] = "0123456789abcdef" [n];
            var r, i, o, s, a = {},
            c = 1,
            h = a,
            l = [],
            ...
            for (n = 1; n != f;) s = t[n],
            n += 1,
            "'" == s ? r ? (o = r.join(""), r = void 0) : r = [] : r ? r.push(s) : "{" == s ? (l.push([h, o]), h = {},
            o = void 0) : "}" == s ? ((i = l.pop())[0][i[1]] = h, o = void 0, h = i[0]) : "-" == s ? c = -1 : void 0 === o ? e.hasOwnProperty(s) ? (u += e[s], o = parseInt(u, 16) * c, c = 1, u = "") : u += s: e.hasOwnProperty(s) ? (p += e[s], h[o] = parseInt(p, 16) * c, c = 1, o = void 0, p = "") : p += s;
            return a
        },
        n = {
        ...
        function(t) {
            var e, n, o; (e = i.Unicode[t.postScriptName]) && ((n = t.metadata.Unicode ? t.metadata.Unicode: t.metadata.Unicode = {}).widths = e.widths, n.kerning = e.kerning),
    ...
    e.API.addSVG = function(t, e, n, r, i) {
        ...
        h = parseFloat(s.getAttribute("height"));
        c && h && (r && i ? a = [r / c, i / h] : r ? a = [r / c, r / c] : i && (a = [i / h, i / h]));
        var l, u, p, f, d = s.childNodes;
        for (l = 0, u = d.length; l < u; l++)(p = d[l]).tagName && "PATH" === p.tagName.toUpperCase() && ((f = function(t) {
            ...
            return [e, n, r]
        } (p.getAttribute("d").split(" ")))[0] = f[0] * a[0] + e, f[1] = f[1] * a[1] + n, this.lines.call(this, f[2], f[0], f[1], a));
        return this
    },
    ...
    e.API.viewerPreferences = function(e, n) {
        ...
        this.internal.viewerpreferences.configuration = JSON.parse(JSON.stringify(a)), this.internal.viewerpreferences.isSubscribed = !1), i = this.internal.viewerpreferences.configuration, "reset" === e || !0 === n) {
            var d = c.length;
            for (p = 0; p < d; p += 1) i[c[p]].value = i[c[p]].defaultValue,
            i[c[p]].explicitSet = !1
        }
        if ("object" === (void 0 === e ? "undefined": t(e))) for (o in e) if (s = e[o], r(c, o) && void 0 !== s) {
            if ("boolean" === i[o].type && "boolean" == typeof s) i[o].value = s;
            else if ("name" === i[o].type && r(i[o].valueSet, s)) i[o].value = s;
            else if ("integer" === i[o].type && Number.isInteger(s)) i[o].value = s;
            else if ("array" === i[o].type) {
                for (l = 0; l < s.length; l += 1) if (f = !0, 1 === s[l].length && "number" == typeof s[l][0]) h.push(String(s[l]));
                else if (s[l].length > 1) {
                    for (u = 0; u < s[l].length; u += 1)"number" != typeof s[l][u] && (f = !1); ! 0 === f && h.push(String(s[l].join("-")))
                }
                i[o].value = String(h)
            } else i[o].value = i[o].defaultValue;
            i[o].explicitSet = !0
        }
        return ! 1 === this.internal.viewerpreferences.isSubscribed && (this.internal.events.subscribe("putCatalog",
        function() {
            var t, e = [];
 ...
 */
    function(t) {
        ...
        e.API.addMetadata = function(t, e) {
            return r = e || "http://jspdf.default.namespaceuri/",
            n = t,
            this.internal.events.subscribe("postPutResources",
            function() {
                if (n) {
                    ...
                    h = o.length + s.length + a.length + e.length + c.length;
                    i = this.internal.newObject(),
                    this.internal.write("<< /Type /Metadata /Subtype /XML /Length " + h + " >>"),
                    this.internal.write("stream"),
                    this.internal.write(e + o + s + a + c),
    ...
    function(t) {
        var e = function() {
            ...
            t.prototype.parse = function() {
                return this.directory = new r(this.contents),
                this.head = new a(this),
                this.name = new d(this),
                this.cmap = new c(this),
                this.hhea = new l(this),
                this.maxp = new m(this),
                this.hmtx = new w(this),
                this.post = new p(this),
                this.os2 = new u(this),
                this.loca = new x(this),
                this.glyf = new y(this),
            ...
            t.prototype.registerTTF = function() {
                ...
                if (this.scaleFactor = 1e3 / this.head.unitsPerEm, this.bbox = function() {
                    var e, n, r, i;
                    for (i = [], e = 0, n = (r = this.bbox).length; e < n; e++) t = r[e],
            ...
            t.prototype.widthOfString = function(t, e, n) {
                var r, i, o, s, a, c;
                for (s = 0, i = a = 0, c = (t = "" + t).length; 0 <= c ? a < c: a > c; i = 0 <= c ? ++a: --a) r = t.charCodeAt(i),
                s += this.widthOfGlyph(this.characterToGlyph(r)) + n * (1e3 / e) || 0;
                return o = e / 1e3,
                s * o
            },
            ...
            t.prototype.encode = function(t, e, n) {
                return t.use(e),
                e = n ? f(t.encodeText(e)) : t.encodeText(e),
                e = function() {
                    for (var t = [], n = 0, r = e.length; 0 <= r ? n < r: n > r; 0 <= r ? n++:n--) t.push(e.charCodeAt(n).toString(16));
                    return t
                } ().join("")
            },
            t.prototype.embedTTF = function(t, e, n) {
                function r(t) {
                    var i;
                    return "Font" === t.Type ? (g && (t.ToUnicode = r(t.ToUnicode) + " 0 R"), t.FontDescriptor = r(t.FontDescriptor) + " 0 R", i = e(), n(I.convert(t))) : "FontDescriptor" === t.Type ? (t.FontFile2 = r(t.FontFile2) + " 0 R", i = e(), n(I.convert(t))) : (i = e(), n("<</Length1 " + t.length + ">>"), n("stream"), n(Array.isArray(t) || t.constructor === Uint8Array ? o(t) : t), n("endstream")),
                    n("endobj"),
                    i
                }
                var i, a, c, l, u, p, f, d, g = "MacRomanEncoding" === t;
                return l = this.subset.encode(),
                f = {},
                f = g ? l: this.rawData,
                u = {
                    Type: "FontDescriptor",
                ...
                (33 == (p = +Object.keys(this.subset.cmap)[0]) || !g) && (i = function() {
                    var t, e;
                    t = this.subset.cmap,
                    e = [];
                    for (c in t) Object.prototype.hasOwnProperty.call(t, c) && (d = t[c], e.push(Math.round(this.widthOfGlyph(d))));
                    return e
                }.call(this), a = h(this.subset.subset), r(g ? {
                    Type: "Font",
                    BaseFont: this.subset.postscriptName,
                    Subtype: "TrueType",
                    FontDescriptor: u,
                    FirstChar: p,
                    LastChar: p + i.length - 1,
                    Widths: i,
                    Encoding: t,
                    ToUnicode: a
                }: {
            ...
            var e = function(t) {
                ...
                var h = t.length;
                a = "=" === t.charAt(h - 2) ? 2 : "=" === t.charAt(h - 1) ? 1 : 0,
                c = new Uint8Array(3 * t.length / 4 - a),
                o = a > 0 ? t.length - 4 : t.length;
                var l = 0;
                for (n = 0, r = 0; n < o; n += 4, r += 3) e((16711680 & (s = i(t.charAt(n)) << 18 | i(t.charAt(n + 1)) << 12 | i(t.charAt(n + 2)) << 6 | i(t.charAt(n + 3)))) >> 16),
                e((65280 & s) >> 8),
                e(255 & s);
                return 2 === a ? e(255 & (s = i(t.charAt(n)) << 2 | i(t.charAt(n + 1)) >> 4)) : 1 === a && (e((s = i(t.charAt(n)) << 10 | i(t.charAt(n + 1)) << 4 | i(t.charAt(n + 2)) >> 2) >> 8 & 255), e(255 & s)),
                c
            },
            i = function(t) {
                var e = "+".charCodeAt(0),
                ...
                a = "_".charCodeAt(0),
                c = t.charCodeAt(0);
                return c === e || c === s ? 62 : c === n || c === a ? 63 : c < r ? -1 : c < r + 10 ? c - r + 26 + 26 : c < o + 26 ? c - o: c < i + 26 ? c - i + 26 : void 0
            },
            o = function(t) {
                for (var e = [], n = 0, r = t.length; n < r; n++) e.push(String.fromCharCode(t[n]));
                return e.join("")
            },
            s = function(t) {
                for (var e = [], n = 0; n < 256; n++) e[n] = 0;
            ...
            h = function(t) {
                var e, n, r, i, o, s, a;
                for (o = "/CIDInit /ProcSet findresource begin\n12 dict begin\nbegincmap\n/CIDSystemInfo <<\n  /Registry (Adobe)\n  /Ordering (UCS)\n  /Supplement 0\n>> def\n/CMapName /Adobe-Identity-UCS def\n/CMapType 2 def\n1 begincodespacerange\n<00><ff>\nendcodespacerange", r = [], s = 0, a = (n = Object.keys(t).sort(function(t, e) {
                    return t - e
                })).length; s < a; s++) e = n[s],
        ...
        n = function() {
            ...
            t.prototype.readUInt32 = function() {
                var t, e, n, r;
                return t = 16777216 * this.readByte(),
                e = this.readByte() << 16,
                n = this.readByte() << 8,
                r = this.readByte(),
                t + e + n + r
            ...
            t.prototype.write = function(t) {
                var e, n, r, i;
                for (i = [], n = 0, r = t.length; n < r; n++) e = t[n],
        ...
        r = function() {
            function t(t) {
                ...
                n = 0, r = this.tableCount; 0 <= r ? n < r: n > r; 0 <= r ? ++n: --n) e = {
                    tag: t.readString(4),
                    checksum: t.readInt(),
                    offset: t.readInt(),
                    length: t.readInt()
            ...
            return t.prototype.encode = function(t) {
                ...
                c = Math.log(2),
                u = 16 * Math.floor(Math.log(d) / c),
                s = Math.floor(u / c),
                l = 16 * d - u,
                (i = new n).writeInt(this.scalarType),
                i.writeShort(d),
                i.writeShort(u),
                i.writeShort(s),
                i.writeShort(l),
                ...
                a = null,
                g = [];
                for (m in t) if (Object.prototype.hasOwnProperty.call(t, m)) for (f = t[m], i.writeString(m), i.writeInt(e(f)), i.writeInt(h), i.writeInt(f.length), g = g.concat(f), "head" === m && (a = h), h += f.length; h % 4;) g.push(0),
                h++;
                return i.write(g),
                p = e(i.data),
                r = 2981146554 - p,
            ...
            e = function(t) {
                ...
                for (r = new n(t), e = 0, o = 0, s = t.length; o < s; o += 4) e += r.readUInt32();
                return 4294967295 & e
            },
            t
        } (),
        ...
        a = function(t) {
            ...
            e.prototype.encode = function(t) {
                var e;
                return (e = new n).writeInt(this.version),
        ...
        c = function(t) {
            ...
            e.prototype.parse = function(t) {
                var e, n, r;
                for (t.pos = this.offset, this.version = t.readUInt16(), n = t.readUInt16(), this.tables = [], r = 0; 0 <= n ? r < n: r > n; 0 <= n ? ++r: --r) e = new h(t, this.offset),
                this.tables.push(e),
                e.isUnicode && void 0 === this.unicode && (this.unicode = e);
                return ! 0
            },
            e.encode = function(t, e) {
                var r, i;
                return void 0 === e && (e = "macroman"),
                r = h.encode(t, e),
                (i = new n).writeUInt16(0),
                i.writeUInt16(1),
                r.table = i.data.concat(r.subtable),
                r
            },
            e
        } (),
        h = function() {
            function t(t, e) {
                var n, r, i, o, s, a, c, h, l, u, p, f, d, g, m, w, y, v;
                switch (this.platformID = t.readUInt16(), this.encodingID = t.readShort(), this.offset = e + t.readInt(), l = t.pos, t.pos = this.offset, this.format = t.readUInt16(), this.length = t.readUInt16(), this.language = t.readUInt16(), this.isUnicode = 3 === this.platformID && 1 === this.encodingID && 4 === this.format || 0 === this.platformID && 4 === this.format, this.codeMap = {},
                this.format) {
                case 0:
                    for (a = m = 0; m < 256; a = ++m) this.codeMap[a] = t.readByte();
                    break;
                case 4:
                    for (p = t.readUInt16(), u = p / 2, t.pos += 6, i = function() {
                        var e, n;
                        for (n = [], a = e = 0; 0 <= u ? e < u: e > u; a = 0 <= u ? ++e: --e) n.push(t.readUInt16());
                        return n
                    } (), t.pos += 2, d = function() {
                        var e, n;
                        for (n = [], a = e = 0; 0 <= u ? e < u: e > u; a = 0 <= u ? ++e: --e) n.push(t.readUInt16());
                        ...
                        var e, n;
                        for (n = [], a = e = 0; 0 <= r ? e < r: e > r; a = 0 <= r ? ++e: --e) n.push(t.readUInt16());
                        return n
                    } (), a = w = 0, v = i.length; w < v; a = ++w) for (g = i[a], n = y = f = d[a]; f <= g ? y <= g: y >= g; n = f <= g ? ++y: --y) 0 === h[a] ? o = n + c[a] : 0 !== (o = s[h[a] / 2 + (n - f) - (u - a)] || 0) && (o += c[a]),
                    this.codeMap[n] = 65535 & o
                }
                t.pos = l
            }
            return t.encode = function(t, e) {
                var r, i, o, s, a, c, h, l, u, p, f, d, g, m, w, y, v, b, x, S, k, C, I, A, T, _, q, O, P, F, E, B, R, D, j, M, U, N, L, z, H, W, V, G, X, Y;
                switch (O = new n, s = Object.keys(t).sort(function(t, e) {
                    return t - e
                }), e) {
                case "macroman":
                    for (g = 0, m = function() {
                    ...
                    o = {},
                    P = 0, R = s.length; P < R; P++) void 0 === y[V = t[i = s[P]]] && (y[V] = ++g),
                    o[i] = {
                        old: t[i],
                        new: y[t[i]]
                    },
                    m[i] = y[t[i]];
                    return O.writeUInt16(1),
                    O.writeUInt16(0),
                    O.writeUInt32(12),
                    O.writeUInt16(0),
                    O.writeUInt16(262),
                ...
                case "unicode":
                    for (_ = [], u = [], v = 0, y = {},
                    r = {},
                    F = 0, D = s.length; F < D; F++) void 0 === y[x = t[i = s[F]]] && (y[x] = ++v),
                    r[i] = {
                        old: x,
                        new: y[x]
                    },
                    a = y[x] - i,
                    void 0 !== w && a === h || (w && u.push(w), _.push(i), h = a),
                    w = i;
                    for (w && u.push(w), u.push(65535), _.push(65535), A = 2 * (I = _.length), C = 2 * Math.pow(Math.log(I) / Math.LN2, 2), p = Math.log(C / 2) / Math.LN2, k = 2 * I - C, c = [], S = [], f = [], d = E = 0, j = _.length; E < j; d = ++E) {
                        if (T = _[d], l = u[d], 65535 === T) {
                            c.push(0),
                            S.push(0);
                            break
                        }
                        if (q = r[T].new, T - q >= 32768) for (c.push(0), S.push(2 * (f.length + I - d)), i = B = T; T <= l ? B <= l: B >= l; i = T <= l ? ++B: --B) f.push(r[i].new);
                        else c.push(q - T),
                        S.push(0)
                    }
                    for (O.writeUInt16(3), O.writeUInt16(1), O.writeUInt32(12), O.writeUInt16(4), O.writeUInt16(16 + 8 * I + 2 * f.length), O.writeUInt16(0), O.writeUInt16(A), O.writeUInt16(C), O.writeUInt16(p), O.writeUInt16(k), H = 0, M = u.length; H < M; H++) i = u[H],
                    O.writeUInt16(i);
                    for (O.writeUInt16(0), W = 0, U = _.length; W < U; W++) i = _[W],
                    O.writeUInt16(i);
                    for (G = 0, N = c.length; G < N; G++) a = c[G],
                    O.writeUInt16(a);
                    for (X = 0, L = S.length; X < L; X++) b = S[X],
                    O.writeUInt16(b);
                    for (Y = 0, z = f.length; Y < z; Y++) g = f[Y],
                    O.writeUInt16(g);
                    return {
                        charMap: r,
                        subtable: O.data,
        ...
        l = function(t) {
            ...
            e.prototype.encode = function(t) {
                var e, r;
                for ((e = new n).writeInt(this.version), e.writeShort(this.ascender), e.writeShort(this.decender), e.writeShort(this.lineGap), e.writeShort(this.advanceWidthMax), e.writeShort(this.minLeftSideBearing), e.writeShort(this.minRightSideBearing), e.writeShort(this.xMaxExtent), e.writeShort(this.caretSlopeRise), e.writeShort(this.caretSlopeRun), e.writeShort(this.caretOffset), r = 0, 8; r < 8; ++r) e.writeByte(0);
                return e.writeShort(this.metricDataFormat),
                e.writeUInt16(t.length),
                e.data
            },
            e
        } (),
        u = function(t) {
            ...
            e.prototype.parse = function(t) {
                ...
                if (t.pos = this.offset, this.version = t.readUInt16(), this.averageCharWidth = t.readShort(), this.weightClass = t.readUInt16(), this.widthClass = t.readUInt16(), this.type = t.readShort(), this.ySubscriptXSize = t.readShort(), this.ySubscriptYSize = t.readShort(), this.ySubscriptXOffset = t.readShort(), this.ySubscriptYOffset = t.readShort(), this.ySuperscriptXSize = t.readShort(), this.ySuperscriptYSize = t.readShort(), this.ySuperscriptXOffset = t.readShort(), this.ySuperscriptYOffset = t.readShort(), this.yStrikeoutSize = t.readShort(), this.yStrikeoutPosition = t.readShort(), this.familyClass = t.readShort(), this.panose = function() {
                    var n, r;
                    for (r = [], e = n = 0; n < 10; e = ++n) r.push(t.readByte());
                    return r
                } (), this.charRange = function() {
                    var n, r;
                    for (r = [], e = n = 0; n < 4; e = ++n) r.push(t.readInt());
                    return r
                } (), this.vendorID = t.readString(4), this.selection = t.readShort(), this.firstCharIndex = t.readShort(), this.lastCharIndex = t.readShort(), this.version > 0 && (this.ascent = t.readShort(), this.descent = t.readShort(), this.lineGap = t.readShort(), this.winAscent = t.readShort(), this.winDescent = t.readShort(), this.codePageRange = function() {
                    var n, r;
                    for (r = [], e = n = 0; n < 2; e = ++n) r.push(t.readInt());
                    return r
                } (), this.version > 1)) return this.xHeight = t.readShort(),
        ...
        p = function(t) {
            ...
            e.prototype.parse = function(t) {
                ...
                case 65536:
                    break;
                case 131072:
                    for (r = t.readUInt16(), this.glyphNameIndex = [], e = i = 0; 0 <= r ? i < r: i > r; e = 0 <= r ? ++i: --i) this.glyphNameIndex.push(t.readUInt16());
                    for (this.names = [], o = []; t.pos < this.offset + this.length;) n = t.readByte(),
                ...
                case 262144:
                    return this.map = function() {
                        var n, r, i;
                        for (i = [], e = n = 0, r = this.file.maxp.numGlyphs; 0 <= r ? n < r: n > r; e = 0 <= r ? ++n: --n) i.push(t.readUInt32());
                        return i
                    }.call(this),
                    this.map
                }
            ...
            e.prototype.glyphFor = function(t) {
                ...
                case 65536:
                    return r[t] || ".notdef";
                case 131072:
                    return (e = this.glyphNameIndex[t]) <= 257 ? r[e] : this.names[e - 258] || ".notdef";
                case 151552:
            ...
            e.prototype.encode = function(t) {
                var e, i, o, s, a, c, h, l, u, p, f, d, g, m, w;
                if (!this.exists) return null;
                if (c = this.raw(), 196608 === this.format) return c;
                for ((u = new n(c.slice(0, 32))).writeUInt32(131072), u.pos = 32, o = [], l = [], p = 0, g = t.length; p < g; p++) e = t[p],
                a = this.glyphFor(e),
                -1 !== (s = r.indexOf(a)) ? o.push(s) : (o.push(257 + l.length), l.push(a));
                for (u.writeUInt16(Object.keys(t).length), f = 0, m = o.length; f < m; f++) i = o[f],
                u.writeUInt16(i);
                for (d = 0, w = l.length; d < w; d++) h = l[d],
                u.writeByte(h.length),
                u.writeString(h);
                return u.data
            },
        ...
        d = function(t) {
            ...
            e.prototype.parse = function(t) {
                var e, n, r, i, o, s, a, c, h, l, u, p;
                for (t.pos = this.offset, t.readShort(), e = t.readShort(), s = t.readShort(), n = [], i = h = 0; 0 <= e ? h < e: h > e; i = 0 <= e ? ++h: --h) n.push({
                ...
                for (a = {},
                i = l = 0, u = n.length; l < u; i = ++l) r = n[i],
                t.pos = r.offset,
                c = t.readString(r.length),
                o = new f(c, r),
                void 0 === a[p = r.nameID] && (a[p] = []),
                a[r.nameID].push(o);
            ...
            r = "AAAAAA",
            e.prototype.encode = function() {
                var t, e, i, o, s, a, c, h, l, u, p, d, m;
                h = {},
                m = this.strings;
                for (t in m) Object.prototype.hasOwnProperty.call(m, t) && (u = m[t], h[t] = u);
                o = new f(r + "+" + this.postscriptName, {
                    platformID: 1,
                    encodingID: 0,
                    languageID: 0
                }),
                ...
                r = g(r),
                s = 0;
                for (t in h) Object.prototype.hasOwnProperty.call(h, t) && null !== (e = h[t]) && (s += e.length);
                l = new n,
                a = new n,
                l.writeShort(0),
                l.writeShort(s),
                l.writeShort(6 + 12 * s);
                for (i in h) if (Object.prototype.hasOwnProperty.call(h, i) && null !== (e = h[i])) for (p = 0, d = e.length; p < d; p++) c = e[p],
                l.writeShort(c.platformID),
                l.writeShort(c.encodingID),
                l.writeShort(c.languageID),
                l.writeShort(i),
                l.writeShort(c.length),
                l.writeShort(a.pos),
                a.writeString(c.raw);
                return {
                    postscriptName: o.raw,
                    table: l.data.concat(a.data)
                }
            },
            e
        } (),
        g = function(t) {
            var e, n, r, i, o, s, a, c, h;
            for (a = (e = "abcdefghijklmnopqrstuvwxyz").length, h = t, r = t.length; r >= 0;) {
                if (s = t.charAt(--r), isNaN(s)) {
                    if ( - 1 === (i = e.indexOf(s.toLowerCase()))) c = s,
                    n = !0;
                    else if (c = e.charAt((i + 1) % a), (o = s === s.toUpperCase()) && (c = c.toUpperCase()), (n = i + 1 >= a) && 0 === r) {
                        h = (o ? "A": "a") + c + h.slice(1);
                        break
                    }
                } else if (c = +s + 1, (n = c > 9) && (c = 0), n && 0 === r) {
                    h = "1" + c + h.slice(1);
                    break
                }
                if (h = h.slice(0, r) + c + h.slice(r + 1), !n) break
            }
            return h
        },
        m = function(t) {
            ...
            e.prototype.encode = function(t) {
                ...
                return (e = new n).writeInt(this.version),
                e.writeUInt16(t.length),
                e.writeUInt16(this.maxPoints),
                e.writeUInt16(this.maxContours),
                e.writeUInt16(this.maxCompositePoints),
                e.writeUInt16(this.maxComponentContours),
                e.writeUInt16(this.maxZones),
                e.writeUInt16(this.maxTwilightPoints),
                e.writeUInt16(this.maxStorage),
                e.writeUInt16(this.maxFunctionDefs),
                e.writeUInt16(this.maxInstructionDefs),
                e.writeUInt16(this.maxStackElements),
                e.writeUInt16(this.maxSizeOfInstructions),
                e.writeUInt16(this.maxComponentElements),
                e.writeUInt16(this.maxComponentDepth),
                e.data
            },
            e
        } (),
        w = function(t) {
            ...
            e.prototype.parse = function(t) {
                var e, n, r, i, o, s, a, c;
                for (t.pos = this.offset, this.metrics = [], e = o = 0, a = this.file.hhea.numberOfMetrics; 0 <= a ? o < a: o > a; e = 0 <= a ? ++o: --o) this.metrics.push({
                ...
                for (r = this.file.maxp.numGlyphs - this.file.hhea.numberOfMetrics, this.leftSideBearings = function() {
                    ...
                    var t, e, n, r;
                    for (r = [], t = 0, e = (n = this.metrics).length; t < e; t++) i = n[t],
                    r.push(i.advance);
                    return r
                }.call(this), n = this.widths[this.widths.length - 1], c = [], e = s = 0; 0 <= r ? s < r: s > r; e = 0 <= r ? ++s: --s) c.push(this.widths.push(n));
                return c
            },
            ...
            e.prototype.encode = function(t) {
                var e, r, i, o, s;
                for (i = new n, o = 0, s = t.length; o < s; o++) e = t[o],
                r = this.forGlyph(e),
        ...
        y = function(t) {
            ...
            e.prototype.glyphFor = function(t) {
                var e, r, i, o, s, a, c, h, l, u;
                return t in this.cache ? this.cache[t] : (o = this.file.loca, e = this.file.contents, r = o.indexOf(t), 0 === (i = o.lengthOf(t)) ? (this.cache[t] = null, this.cache[t]) : (e.pos = this.offset + r, a = new n(e.read(i)), s = a.readShort(), h = a.readShort(), u = a.readShort(), c = a.readShort(), l = a.readShort(), this.cache[t] = -1 === s ? new b(a, h, u, c, l) : new v(a, s, h, u, c, l), this.cache[t]))
            },
            e.prototype.encode = function(t, e, n) {
                var r, i, o, s, a;
                for (o = [], i = [], s = 0, a = e.length; s < a; s++) r = t[e[s]],
                i.push(o.length),
        ...
        b = function() {
            function t(t, n, i, c, h) {
                var l, u;
                for (this.raw = t, this.xMin = n, this.yMin = i, this.xMax = c, this.yMax = h, this.compound = !0, this.glyphIDs = [], this.glyphOffsets = [], l = this.raw;;) {
                    if (u = l.readShort(), this.glyphOffsets.push(l.pos), this.glyphIDs.push(l.readShort()), !(u & r)) break;
                    l.pos += u & e ? 4 : 2,
                    u & a ? l.pos += 8 : u & o ? l.pos += 4 : u & s && (l.pos += 2)
                }
            }
            var e, r, o, s, a;
            return e = 1,
            ...
            t.prototype.encode = function(t) {
                var e, r, o, s, a, c;
                for (o = new n(i.call(this.raw.data)), e = s = 0, a = (c = this.glyphIDs).length; s < a; e = ++s) r = c[e],
                o.pos = this.glyphOffsets[e],
                o.writeShort(t[r]);
                return o.data
            },
            t
        ...
        x = function(t) {
            ...
            e.prototype.parse = function(t) {
                var e;
                return t.pos = this.offset,
                0 === this.file.head.indexToLocFormat ? (this.offsets = function() {
                    var n, r, i;
                    for (i = [], e = n = 0, r = this.length; n < r; e = n += 2) i.push(2 * t.readUInt16());
                    return i
                }.call(this), this) : (this.offsets = function() {
                    var n, r, i;
                    for (i = [], e = n = 0, r = this.length; n < r; e = n += 4) i.push(t.readUInt32());
                    return i
                }.call(this), this)
            },
            ...
            e.prototype.encode = function(t) {
                var e, r, i, o, s, a, c, h, l;
                for (r = new n, i = 0, a = t.length; i < a; i++) if (t[i] > 65535) {
                    for (o = 0, c = (l = this.offsets).length; o < c; o++) e = l[o],
                    r.writeUInt32(e);
                    return {
                        format: 1,
                        table: r.data
                ...
                for (s = 0, h = t.length; s < h; s++) e = t[s],
                r.writeUInt16(e / 2);
                return {
                    format: 0,
                    table: r.data
        ...
        S = function() {
            ...
            return t.prototype.use = function(t) {
                var e, n, r;
                if ("string" != typeof t) {
                    if (!this.unicodes[t]) return this.subset[this.next] = t,
                    this.unicodes[t] = this.next++,
                    this
                } else for (e = n = 0, r = t.length; 0 <= r ? n < r: n > r; e = 0 <= r ? ++n: --n) this.use(t.charCodeAt(e))
            },
            t.prototype.encodeText = function(t) {
                var e, n, r, i, o;
                for (r = "", n = i = 0, o = t.length; 0 <= o ? i < o: i > o; n = 0 <= o ? ++i: --i) e = this.unicodes[t.charCodeAt(n)],
            ...
            t.prototype.glyphIDs = function() {
                var t, e, n, r, i;
                n = this.font.cmap.tables[0].codeMap,
                t = [0],
                i = this.subset;
                for (e in i) Object.prototype.hasOwnProperty.call(i, e) && null !== (r = n[i[e]]) && k.call(t, r) < 0 && t.push(r);
                return t.sort()
            },
            t.prototype.glyphsFor = function(t) {
                var e, n, r, i, o, s, a;
                for (r = {},
                o = 0, s = t.length; o < s; o++) r[i = t[o]] = this.font.glyf.glyphFor(i);
                e = [];
                for (i in r) Object.prototype.hasOwnProperty.call(r, i) && (null !== (n = r[i]) ? n.compound: void 0) && e.push.apply(e, n.glyphIDs);
                if (e.length > 0) {
                    a = this.glyphsFor(e);
            ...
            t.prototype.encode = function() {
                var t, e, n, r, i, o, s, a, h, l, u, p, f, d, g, m, w;
                t = c.encode(this.generateCmap(), "unicode"),
                r = this.glyphsFor(this.glyphIDs()),
                p = {
                    0 : 0
                },
                m = t.charMap;
                for (e in m) Object.prototype.hasOwnProperty.call(m, e) && (p[(o = m[e]).old] = o.new);
                u = t.maxGlyphID;
                for (f in r) f in p || (p[f] = u++);
                h = C(p),
                l = Object.keys(h).sort(function(t, e) {
                    return t - e
                }),
                d = function() {
                    var t, e, n;
                    for (n = [], t = 0, e = l.length; t < e; t++) i = l[t],
                    n.push(h[i]);
                    return n
                } (),
                n = this.font.glyf.encode(r, d, p),
                s = this.font.loca.encode(n.offsets),
                a = this.font.name.encode(),
                this.postscriptName = a.postscriptName,
                this.cmap = {},
                w = t.charMap;
                for (e in w) Object.prototype.hasOwnProperty.call(w, e) && (o = w[e], this.cmap[e] = o.old);
                return g = {
                    cmap: t.table,
                    glyf: n.table,
                    loca: s.table,
                    hmtx: this.font.hmtx.encode(d),
                    hhea: this.font.hhea.encode(d),
                    maxp: this.font.maxp.encode(d),
                    post: this.font.post.encode(d),
                    name: a.table,
        ...
        I = function() {
            ...
            t.convert = function(n) {
                ...
                function() {
                    var e, i, o;
                    for (o = [], e = 0, i = n.length; e < i; e++) r = n[e],
                    o.push(t.convert(r));
                    return o
                } ().join(" ") + "]";
                ...
                if ("[object Object]" === {}.toString.call(n)) {
                    o = ["<<"];
                    for (i in n) Object.prototype.hasOwnProperty.call(n, i) && (s = n[i], o.push("/" + i + " " + t.convert(s)));
                    return o.push(">>"),
                    o.join("\n")
                }
                return "" + n
        ...
        t.events.push(["addFont",
        function(n) {
            t.existsFileInVFS(n.postScriptName) ? (n.metadata = e.open(n.postScriptName, n.fontName, t.getFileFromVFS(n.postScriptName), n.encoding), n.encoding = n.metadata.hmtx.widths.length < 500 && n.metadata.capHeight < 800 ? "WinAnsiEncoding": "MacRomanEncoding") : n.id.slice(1) >= 14 && console.error("Font does not exist in FileInVFS, import fonts or remove declaration doc.addFont('" + n.postScriptName + "').")
        }])
    } (e.API),
    function(t) {
        var e = {};
    ...
    function(t) {
        ...
        var e = t.BlobBuilder || t.WebKitBlobBuilder || t.MozBlobBuilder ||
        function(t) {
            var e = function(t) {
            ...
            return l.createObjectURL || (f = t.URL = function(t) {
                ...
                return n.href = t,
                "origin" in n || ("data:" === n.protocol.toLowerCase() ? n.origin = null: (e = t.match(y), n.origin = e && e[1])),
                n
            }),
            f.createObjectURL = function(t) {
                var e, n = t.type;
                return null === n && (n = "application/octet-stream"),
                t instanceof r ? (e = "data:" + n, "base64" === t.encoding ? e + ";base64," + t.data: "URI" === t.encoding ? e + "," + decodeURIComponent(t.data) : d ? e + ";base64," + d(t.data) : e + "," + encodeURIComponent(t.data)) : u ? u.call(l, t) : void 0
            },
            f.revokeObjectURL = function(t) {
                "data:" !== t.substring(0, 5) && p && p.call(l, t)
            },
            i.append = function(t) {
                var n = this.data;
                if (w && (t instanceof m || t instanceof w)) {
                    for (var i = "",
                    o = new w(t), c = 0, h = o.length; c < h; c++) i += String.fromCharCode(o[c]);
                    n.push(i)
        ...
        t.Blob = function(t, n) {
            ...
            i = new e;
            if (t) for (var o = 0,
            s = t.length; o < s; o++) Uint8Array && t[o] instanceof Uint8Array ? i.append(t[o].buffer) : i.append(t[o]);
            var a = i.getBlob(r);
    ...
    function(t) {
        if (! (void 0 === t || "undefined" != typeof navigator && /MSIE [1-9]\./.test(navigator.userAgent))) {
            ...
            a = function(e) { (t.setImmediate || t.setTimeout)(function() {
                    throw e
                },
                0)
            },
            ...
            u = function(a, u, p) {
                p || (a = l(a));
                var f, d = this,
                g = "application/octet-stream" === a.type,
                m = function() {
                    h(d, "writestart progress write writeend".split(" "))
                };
                if (d.readyState = d.INIT, r) return f = e().createObjectURL(a),
                ...
                function() {
                    if ((s || g && o) && t.FileReader) {
                        var n = new FileReader;
                        return n.onloadend = function() {
                            var e = s ? n.result: n.result.replace(/^data:[^;]*;/, "data:attachment/file;");
                    ...
                    f || (f = e().createObjectURL(a)),
                    g ? t.location.href = f: t.open(f, "_blank") || (t.location.href = f),
                    d.readyState = d.DONE,
                    m(),
                    c(f)
                } ()
            ...
            p.readyState = p.INIT = 0, p.WRITING = 1, p.DONE = 2, p.error = p.onwritestart = p.onprogress = p.onwrite = p.onabort = p.onerror = p.onwriteend = null,
            function(t, e, n) {
                return new u(t, e || t.name || "download", n)
            })
        }
    } ("undefined" != typeof self && self || "undefined" != typeof window && window || window.content);
    "undefined" != typeof module && module.exports ? module.exports.saveAs = r: "undefined" != typeof define && null !== define && null !== define.amd && define("FileSaver.js",
    function() {
        return r
    }),
    function(t, e) {
    ...
    function() {
        ...
        i = function(t, e) {
            ...
            r = t >>> 16,
            i = 0,
            o = e.length; i < o; i++) r = (r + (n = (n + (255 & e.charCodeAt(i))) % 65521)) % 65521;
            return (r << 16 | n) >>> 0
        },
        o = function(t, e) {
            for (var n = 65535 & t,
            r = t >>> 16,
            i = 0,
            o = e.length; i < o; i++) r = (r + (n = (n + e[i]) % 65521)) % 65521;
            return (r << 16 | n) >>> 0
        },
        s = {},
    ...
    function(t) {
        ...
        return function t(e, n, r) {
            ...
            1 : [function(t, e, n) { (function(t) { !
                    function(r) {
                        ...
                        function c(t) {
                            ...
                            function(t) {
                                var e = "";
                                return t > 65535 && (e += B((t -= 65536) >>> 10 & 1023 | 55296), t = 56320 | 1023 & t),
                                e += B(t)
                            }).join("")
                        }
                        function h(t) {
                        ...
                        function u(t, e, n) {
                            var r = 0;
                            for (t = n ? E(t / C) : t >> 1, t += E(t / e); t > F * S >> 1; r += b) t = E(t / F);
                            return E(r + (F + 1) * t / (t + k))
                        }
                        function p(t) {
                            var e, n, r, o, s, a, l, p, f, d, g = [],
                            m = t.length,
                            w = 0,
                            y = A,
                            k = I;
                            for ((n = t.lastIndexOf(T)) < 0 && (n = 0), r = 0; r < n; ++r) t.charCodeAt(r) >= 128 && i("not-basic"),
                            g.push(t.charCodeAt(r));
                            for (o = n > 0 ? n + 1 : 0; o < m;) {
                                for (s = w, a = 1, l = b; o >= m && i("invalid-input"), ((p = h(t.charCodeAt(o++))) >= b || p > E((v - w) / a)) && i("overflow"), w += p * a, f = l <= k ? x: l >= k + S ? S: l - k, !(p < f); l += b) a > E(v / (d = b - f)) && i("overflow"),
                                a *= d;
                                k = u(w - s, e = g.length + 1, 0 == s),
                                E(w / e) > v - y && i("overflow"),
                                y += E(w / e),
                                w %= e,
                                g.splice(w++, 0, y)
                            }
                        ...
                        function f(t) {
                            var e, n, r, o, s, c, h, p, f, d, g, m, w, y, k, C = [];
                            for (m = (t = a(t)).length, e = A, n = 0, s = I, c = 0; c < m; ++c)(g = t[c]) < 128 && C.push(B(g));
                            for (r = o = C.length, o && C.push(T); r < m;) {
                                for (h = v, c = 0; c < m; ++c)(g = t[c]) >= e && g < h && (h = g);
                                for (h - e > E((v - n) / (w = r + 1)) && i("overflow"), n += (h - e) * w, e = h, c = 0; c < m; ++c) if ((g = t[c]) < e && ++n > v && i("overflow"), g == e) {
                                    for (p = n, f = b; d = f <= s ? x: f >= s + S ? S: f - s, !(p < d); f += b) k = p - d,
                                    y = b - d,
                                    C.push(B(l(d + k % y, 0))),
                                    p = E(k / y);
                                    C.push(B(l(p, 0))),
                        ...
                        g = "object" == typeof e && e && e.exports == d && e,
                        m = "object" == typeof t && t;
                        ...
                        if (w = {
                            ...
                            toASCII: function(t) {
                                return s(t,
                                function(t) {
                                    return q.test(t) ? "xn--" + f(t) : t
                                })
                            },
                            toUnicode: function(t) {
                                return s(t,
                                function(t) {
                                    return _.test(t) ? p(t.slice(4).toLowerCase()) : t
                                })
                            }
                        },
                        d && !d.nodeType) if (g) g.exports = w;
                        else for (y in w) w.hasOwnProperty(y) && (d[y] = w[y]);
                        else r.punycode = w
                    } (this)
            ...
            2 : [function(t, e, n) {
                ...
                function o(t, e) {
                    for (var n = 3 === t.nodeType ? document.createTextNode(t.nodeValue) : t.cloneNode(!1), r = t.firstChild; r;) ! 0 !== e && 1 === r.nodeType && "SCRIPT" === r.nodeName || n.appendChild(o(r, e)),
                    r = r.nextSibling;
                    return 1 === t.nodeType && (n._scrollTop = t.scrollTop, n._scrollLeft = t.scrollLeft, "CANVAS" === t.nodeName ? i(t, n) : "TEXTAREA" !== t.nodeName && "SELECT" !== t.nodeName || (n.value = t.value)),
                    n
                }
                function s(t) {
                    if (1 === t.nodeType) {
                ...
                var a = t("./log");
                e.exports = function(t, e, n, i, a, c, h) {
                    var l = o(t.documentElement, a.javascriptEnabled),
            ...
            3 : [function(t, e, n) {
                ...
                r.prototype.hex3 = function(t) {
                    var e = null;
                    return null !== (e = t.match(i)) && (this.r = parseInt(e[1][0] + e[1][0], 16), this.g = parseInt(e[1][1] + e[1][1], 16), this.b = parseInt(e[1][2] + e[1][2], 16)),
                    null !== e
                };
                var o = /^#([a-f0-9]{6})$/i;
                r.prototype.hex6 = function(t) {
                    var e = null;
                    return null !== (e = t.match(o)) && (this.r = parseInt(e[1].substring(0, 2), 16), this.g = parseInt(e[1].substring(2, 4), 16), this.b = parseInt(e[1].substring(4, 6), 16)),
                    null !== e
                };
                ...
                r.prototype.rgba = function(t) {
                    var e = null;
                    return null !== (e = t.match(a)) && (this.r = Number(e[1]), this.g = Number(e[2]), this.b = Number(e[3]), this.a = Number(e[4])),
                    null !== e
                },
            ...
            4 : [function(t, e, n) {
                function r(t, e) {
                    var n = S++;
                    if ((e = e || {}).logging && (m.options.logging = !0, m.options.start = Date.now()), e.async = void 0 === e.async || e.async, e.allowTaint = void 0 !== e.allowTaint && e.allowTaint, e.removeContainer = void 0 === e.removeContainer || e.removeContainer, e.javascriptEnabled = void 0 !== e.javascriptEnabled && e.javascriptEnabled, e.imageTimeout = void 0 === e.imageTimeout ? 1e4: e.imageTimeout, e.renderer = "function" == typeof e.renderer ? e.renderer: p, e.strict = !!e.strict, "string" == typeof t) {
                        ...
                        return v(l(t), e.proxy, document, r, s, e).then(function(t) {
                            return o(t.contentWindow.document.documentElement, t, e, r, s)
                        })
                    }
                    var a = (void 0 === t ? [document.documentElement] : t.length ? t: [t])[0];
                    return a.setAttribute(x + n, n),
                    i(a.ownerDocument, e, a.ownerDocument.defaultView.innerWidth, a.ownerDocument.defaultView.innerHeight, n).then(function(t) {
                ...
                function i(t, e, n, r, i) {
                    return y(t, t, n, r, e, t.defaultView.pageXOffset, t.defaultView.pageYOffset).then(function(s) {
                        m("Document cloned");
                        var a = x + i,
                        c = "[" + a + "='" + i + "']";
                        t.querySelector(c).removeAttribute(a);
                        var h = s.contentWindow,
                        l = h.document.querySelector(c);
                        return ("function" == typeof e.onclone ? Promise.resolve(e.onclone(h.document)) : Promise.resolve(!0)).then(function() {
                            return o(l, s, e, n, r)
                        })
                    })
                }
                function o(t, e, n, r, i) {
                    ...
                    y = "view" === n.type ? i: h(o.document),
                    v = new n.renderer(w, y, p, n, document);
                    return new d(t, v, l, p, n).ready.then(function() {
                        m("Finished rendering");
                        var r;
                        return r = "view" === n.type ? a(v.canvas, {
                            ...
                            x: 0,
                            y: 0
                        }) : t === o.document.body || t === o.document.documentElement || null != n.canvas ? v.canvas: a(v.canvas, {
                            width: null != n.width ? n.width: g.width,
                            height: null != n.height ? n.height: g.height,
                            top: g.top,
                            left: g.left,
                            x: 0,
                            y: 0
                ...
                function a(t, e) {
                    ...
                    var a = i - r,
                    c = s - o;
                    return m("Cropping canvas at:", "left:", e.left, "top:", e.top, "width:", a, "height:", c),
                    m("Resulting crop with width", e.width, "and height", e.height, "with x", r, "and y", o),
                    n.getContext("2d").drawImage(t, r, o, a, c, e.x, e.y, a, c),
                    n
                }
                function c(t) {
            ...
            11 : [function(t, e, n) {
                ...
                r.prototype.loadImage = function(t) {
                    if ("url" === t.method) {
                        var e = t.args[0];
                        return ! this.isSVG(e) || this.support.svg || this.options.allowTaint ? e.match(/data:image\/.*;base64,/i) ? new o(e.replace(/url\(['"]{0,}|['"]{0,}\)$/gi, ""), !1) : this.isSameOrigin(e) || !0 === this.options.allowTaint || this.isSVG(e) ? new o(e, !1) : this.support.cors && !this.options.allowTaint && this.options.useCORS ? new o(e, !0) : this.options.proxy ? new a(e, this.options.proxy) : new s(e) : new h(e)
                    }
                    return "linear-gradient" === t.method ? new u(t) : "gradient" === t.method ? new p(t) : "svg" === t.method ? new l(t.args[0], this.support.svg) : "IFRAME" === t.method ? new c(t.args[0], this.isSameOrigin(t.args[0].src), this.options) : new s(t)
                },
            ...
            13 : [function(t, e, n) {
                var r = function() {
                    r.options.logging && window.console && window.//console.log && Function.prototype.bind.call(win//console.logog, window.console).apply(window.console, [Date.now() - r.options.start + "ms", "html2canvas:"].concat([].slice.call(arguments, 0)))
                };
                r.options = {
                    logging: !1
                },
            ...
            14 : [function(t, e, n) {
                ...
                r.prototype.cssList = function(t, e) {
                    ...
                    1 === (n = n.trim().split(" ")).length && (n = [n[0], s(n[0]) ? "auto": n[0]]),
                    n
                },
                r.prototype.parseBackgroundSize = function(t, e, n) {
                    ...
                    return i = "auto" === o[0] && "auto" === o[1] ? e.height: "auto" === o[1] ? r / e.width * e.height: s(o[1]) ? t.height * parseFloat(o[1]) / 100 : parseInt(o[1], 10),
                ...
                r.prototype.parseBackgroundPosition = function(t, e, n, r) {
                    ...
                    return i = s(a[0]) ? (t.width - (r || e).width) * (parseFloat(a[0]) / 100) : parseInt(a[0], 10),
                    o = "auto" === a[1] ? i / e.width * e.height: s(a[1]) ? (t.height - (r || e).height) * parseFloat(a[1]) / 100 : parseInt(a[1], 10),
                ...
                r.prototype.parseBounds = function() {
                    return this.bounds || (this.bounds = this.hasTransform() ? f(this.node) : u(this.node))
                },
            ...
            15 : [function(t, e, n) {
                function r(t, e, n, r, i) {
                    ...
                    if (i.background && e.rectangle(0, 0, e.width, e.height, new G(i.background)), t === t.ownerDocument.documentElement) {
                        var s = new z(o.color("backgroundColor").isTransparent() ? t.ownerDocument.body: t.ownerDocument.documentElement, null);
                    ...
                    this.nodes = R([o].concat(this.getChildren(o)).filter(function(t) {
                ...
                function h(t, e, n) {
                    ...
                    return {
                        ...
                        topRightOuter: c(r + m, i, l, u).topRight.subdivide(.5),
                        topRightInner: c(r + Math.min(m, o + n[3].width), i + n[0].width, m > o + n[3].width ? 0 : l - n[3].width, u - n[0].width).topRight.subdivide(.5),
                        bottomRightOuter: c(r + y, i + w, p, f).bottomRight.subdivide(.5),
                        bottomRightInner: c(r + Math.min(y, o - n[3].width), i + Math.min(w, s + n[0].width), Math.max(0, p - n[1].width), f - n[2].width).bottomRight.subdivide(.5),
                        bottomLeftOuter: c(r, i + v, d, g).bottomLeft.subdivide(.5),
                        bottomLeftInner: c(r + n[3].width, i + v, Math.max(0, d - n[3].width), g - n[2].width).bottomLeft.subdivide(.5)
                    }
                }
                function l(t, e, n, r) {
                ...
                function u(t, e, n, r, i, o, s) {
                    ...
                    n[0] > 0 || n[1] > 0 ? (a.push(["line", o[0].start.x, o[0].start.y]), o[0].curveTo(a), a.push(["line", s[0].end.x, s[0].end.y]), s[0].curveToReversed(a)) : (a.push(["line", t.c2[0], t.c2[1]]), a.push(["line", t.c3[0], t.c3[1]])),
                ...
                function j(t) {
                    for (var e, n = [], r = 0, i = !1; t.length;) M(t[r]) === i ? ((e = t.splice(0, r)).length && n.push(L.ucs2.encode(e)), i = !i, r = 0) : r++,
                    r >= t.length && (e = t.splice(0, r)).length && n.push(L.ucs2.encode(e));
                    return n
                }
                function M(t) {
                ...
                r.prototype.calculateOverflowClips = function() {
                    this.nodes.forEach(function(t) {
                        if (T(t)) {
                            ...
                            _(t) && t.cleanDOM()
                        } else q(t) && (t.clip = i(t) ? t.parent.clip: []);
                        _(t) || (t.bounds = null)
                    },
                    this)
                },
                ...
                r.prototype.getPseudoElement = function(t, e) {
                    ...
                    for (var r = D(n.content), i = "url" === r.substr(0, 3), s = document.createElement(i ? "img": "html2canvaspseudoelement"), a = new W(s, t, e), c = n.length - 1; c >= 0; c--) {
                        var h = o(n.item(c));
                        s.style[h] = n[h]
                    }
                    if (s.className = W.prototype.PSEUDO_HIDE_ELEMENT_CLASS_BEFORE + " " + W.prototype.PSEUDO_HIDE_ELEMENT_CLASS_AFTER, i) return s.src = K(r)[0].args[0],
                    [a];
                ...
                r.prototype.getChildren = function(t) {
                    return R([].filter.call(t.node.childNodes, x).map(function(e) {
                        var n = [e.nodeType === Node.TEXT_NODE ? new H(e, t) : new z(e, t)].filter(B);
                ...
                r.prototype.createStackingContexts = function() {
                    this.nodes.forEach(function(t) {
                        T(t) && (this.isRootElement(t) || P(t) || S(t) || this.isBodyWithTransparentRoot(t) || t.hasTransform()) ? this.newStackingContext(t, !0) : T(t) && (k(t) && g(t) || I(t) || C(t)) ? this.newStackingContext(t, !1) : t.assignStack(t.parent.stack)
                    },
                    this)
                },
                ...
                r.prototype.sortStackingContexts = function(t) {
                    t.contexts.sort(O(t.contexts.slice(0))),
                ...
                r.prototype.parse = function(t) {
                    ...
                    r = n.filter(A(C)),
                    i = r.filter(A(k)).filter(A(m)),
                    o = n.filter(A(k)).filter(C),
                    a = r.filter(A(k)).filter(m),
                    c = t.contexts.concat(r.filter(k)).filter(g),
                    h = t.children.filter(q).filter(y),
                    l = t.contexts.filter(d);
                    e.concat(i).concat(o).concat(a).concat(c).concat(h).concat(l).forEach(function(t) {
                        this.renderQueue.push(t),
                        w(t) && (this.parse(t), this.renderQueue.push(new s))
                    },
                    this)
                },
                r.prototype.paint = function(t) {
                    try {
                        t instanceof s ? this.renderer.ctx.restore() : q(t) ? (_(t.parent) && t.parent.appendToDOM(), this.paintText(t), _(t.parent) && t.parent.cleanDOM()) : this.paintNode(t)
                    } catch(t) {
                        if (N(t), this.options.strict) throw t
                    }
                },
                ...
                r.prototype.paintElement = function(t) {
                    ...
                    function() {
                        ...
                        case "IFRAME":
                            ...
                            n ? this.renderer.renderImage(t, e, t.borders, n) : N("Error loading <" + t.node.nodeName + ">", t.node);
                            break;
                        case "IMG":
                            var r = this.images.get(t.node.src);
                            r ? this.renderer.renderImage(t, e, t.borders, r) : N("Error loading <img>", t.node.src);
                            break;
                        case "CANVAS":
                ...
                r.prototype.paintCheckbox = function(t) {
                    ...
                    this.renderer.clip(t.backgroundClip,
                    function() {
                        this.renderer.rectangle(r.left + 1, r.top + 1, r.width - 2, r.height - 2, new G("#DEDEDE")),
                        this.renderer.renderBorders(a(s, r, c, o)),
                        t.node.checked && (this.renderer.font(new G("#424242"), "normal", "normal", "bold", n - 3 + "px", "arial"), this.renderer.text("✔", r.left + n / 6, r.top + n - 1))
                    },
                    this)
                },
                r.prototype.paintRadio = function(t) {
                    ...
                    this.renderer.clip(t.backgroundClip,
                    function() {
                        this.renderer.circleStroke(e.left + 1, e.top + 1, n, new G("#DEDEDE"), 1, new G("#A5A5A5")),
                        t.node.checked && this.renderer.circle(Math.ceil(e.left + n / 4) + 1, Math.ceil(e.top + n / 4) + 1, Math.floor(n / 2), new G("#424242"))
                    },
                    this)
                },
                    ...
                    if (e.length > 0) {
                        ...
                        r = n.createElement("html2canvaswrapper"); ["lineHeight", "textAlign", "fontFamily", "fontWeight", "fontSize", "color", "paddingLeft", "paddingTop", "paddingRight", "paddingBottom", "width", "height", "borderLeftStyle", "borderTopStyle", "borderLeftWidth", "borderTopWidth", "boxSizing", "whiteSpace", "wordWrap"].forEach(function(e) {
                            try {
                                ...
                                N("html2canvas: Parse: Exception caught in renderFormValue: " + t.message)
                            }
                        });
                        var i = t.parseBounds();
                ...
                r.prototype.paintText = function(t) {
                    ...
                    var e = L.ucs2.decode(t.node.data),
                    n = this.options.letterRendering && !v(t) || U(t.node.data) ? e.map(function(t) {
                        return L.ucs2.encode([t])
                    }) : j(e),
                ...
                r.prototype.parseBackgroundClip = function(t, e, n, r, i) {
                    ...
                    case "content-box":
                    case "padding-box":
                        p(o, r[0], r[1], e.topLeftInner, e.topRightInner, i.left + n[3].width, i.top + n[0].width),
                        p(o, r[1], r[2], e.topRightInner, e.bottomRightInner, i.left + i.width - n[1].width, i.top + n[0].width),
                        p(o, r[2], r[3], e.bottomRightInner, e.bottomLeftInner, i.left + i.width - n[1].width, i.top + i.height - n[2].width),
                        p(o, r[3], r[0], e.bottomLeftInner, e.topLeftInner, i.left + n[3].width, i.top + i.height - n[2].width);
                        break;
                    default:
                        p(o, r[0], r[1], e.topLeftOuter, e.topRightOuter, i.left, i.top),
                        p(o, r[1], r[2], e.topRightOuter, e.bottomRightOuter, i.left + i.width, i.top),
                        p(o, r[2], r[3], e.bottomRightOuter, e.bottomLeftOuter, i.left + i.width, i.top + i.height),
                        p(o, r[3], r[0], e.bottomLeftOuter, e.topLeftOuter, i.left, i.top + i.height)
                    }
                    return o
                },
                e.exports = r
            ...
            16 : [function(t, e, n) {
                function r(t, e, n) {
                    ...
                    var a = o(r),
                    h = s(e, t, a);
                    return r ? c(h) : i(n, h, a).then(function(t) {
                        return p(t.content)
                    })
                }
                function i(t, e, n) {
                ...
                n.loadUrlDocument = function(t, e, n, i, o, s) {
                    return new r(t, e, window.document).then(a(t)).then(function(t) {
            ...
            19 : [function(t, e, n) {
                ...
                r.prototype.renderImage = function(t, e, n, r) {
                    ...
                    this.drawImage(r, 0, 0, r.image.width || h, r.image.height || l, e.left + i + c[3].width, e.top + o + c[0].width, h, l)
                },
            ...
            20 : [function(t, e, n) {
                ...
                a = t("../log"); (r.prototype = Object.create(o.prototype)).setFillStyle = function(t) {
            ...
            21 : [function(t, e, n) {
                ...
                var i = t("./nodecontainer"); (r.prototype = Object.create(i.prototype)).getParentStack = function(t) {
            ...
            22 : [function(t, e, n) {
                ...
                r.prototype.testRangeBounds = function(t) {
                    var e, n, r = !1;
                    return t.createRange && (e = t.createRange()).getBoundingClientRect && ((n = t.createElement("boundtest")).style.height = "123px", n.style.display = "block", t.body.appendChild(n), e.selectNode(n), 123 === e.getBoundingClientRect().height && (r = !0), t.body.removeChild(n)),
                    r
                },
            ...
            25 : [function(t, e, n) {
                ...
                var o = t("./nodecontainer"); (r.prototype = Object.create(o.prototype)).applyTextTransform = function() {
 ...
 */
                n.decode64 = function(t) {
                    ...
                    h = t.length,
                    l = "";
                    for (e = 0; e < h; e += 4) o = c.indexOf(t[e]) << 2 | (n = c.indexOf(t[e + 1])) >> 4,
                    s = (15 & n) << 4 | (r = c.indexOf(t[e + 2])) >> 2,
                    a = (3 & r) << 6 | (i = c.indexOf(t[e + 3])),
                    l += 64 === r ? String.fromCharCode(o) : 64 === i || -1 === i ? String.fromCharCode(o, s) : String.fromCharCode(o, s, a);
                    return l
                },
                ...
                n.parseBackgrounds = function(t) {
                    ...
                    t.split("").forEach(function(t) {
                        if (! (0 === h && " \r\n\t".indexOf(t) > -1)) {
                            ...
                            case ",":
                                if (s) break;
                                if (0 === h) return void u();
                                if (1 === h && 0 === l && !e.match(/^url$/i)) return a.push(n),
                                n = "",
                                void(o += t)
                            }
                            o += t,
...
*/
    function(t) {
        ...
        e = function() {
            function e(t) {
                var e, n, r, i, o, s, a, c, h, l, u, p, f, d, g;
                ...
                s = null;;) {
                    switch (e = this.readUInt32(), l = function() {
                        var t, e;
                        for (e = [], a = t = 0; t < 4; a = ++t) e.push(String.fromCharCode(this.data[this.pos++]));
                        return e
                    }.call(this).join("")) {
                    case "IHDR":
                    ...
                    case "IDAT":
                    case "fdAT":
                        for ("fdAT" === l && (this.pos += 4, e -= 4), t = (null != s ? s.data: void 0) || this.imgData, a = f = 0; 0 <= e ? f < e: f > e; a = 0 <= e ? ++f: --f) t.push(this.data[this.pos++]);
                        break;
                    case "tRNS":
                        ...
                        case 3:
                            ...
                            if ((u = r - this.transparency.indexed.length) > 0) for (a = d = 0; 0 <= u ? d < u: d > u; a = 0 <= u ? ++d: --d) this.transparency.indexed.push(255);
                            break;
                        case 0:
                        ...
                        break;
                    case "tEXt":
                        c = (p = this.read(e)).indexOf(0),
                        h = String.fromCharCode.apply(String, p.slice(0, c)),
                        this.text[h] = String.fromCharCode.apply(String, p.slice(c + 1));
                        break;
                    case "IEND":
            ...
            e.prototype.decodePixels = function(t) {
                var e, n, r, i, s, a, c, h, l, u, p, f, d, g, m, w, y, v, b, x, S, k, C;
                if (null == t && (t = this.imgData), 0 === t.length) return new Uint8Array(0);
                for (t = (t = new o(t)).getBytes(), w = (f = this.pixelBitlength / 8) * this.width, d = new Uint8Array(w * this.height), a = t.length, m = 0, g = 0, n = 0; g < a;) {
                    switch (t[g++]) {
                    case 0:
                        for (i = b = 0; b < w; i = b += 1) d[n++] = t[g++];
                        break;
                    case 1:
                        for (i = x = 0; x < w; i = x += 1) e = t[g++],
                        s = i < f ? 0 : d[n - f],
                        d[n++] = (e + s) % 256;
                        break;
                    case 2:
                        for (i = S = 0; S < w; i = S += 1) e = t[g++],
                        r = (i - i % f) / f,
                        y = m && d[(m - 1) * w + r * f + i % f],
                        d[n++] = (y + e) % 256;
                        break;
                    case 3:
                        for (i = k = 0; k < w; i = k += 1) e = t[g++],
                        r = (i - i % f) / f,
                        s = i < f ? 0 : d[n - f],
                        y = m && d[(m - 1) * w + r * f + i % f],
                        d[n++] = (e + Math.floor((s + y) / 2)) % 256;
                        break;
                    case 4:
                        for (i = C = 0; C < w; i = C += 1) e = t[g++],
                        r = (i - i % f) / f,
                        s = i < f ? 0 : d[n - f],
                        0 === m ? y = v = 0 : (y = d[(m - 1) * w + r * f + i % f], v = r && d[(m - 1) * w + (r - 1) * f + i % f]),
                        c = s + y - v,
                        h = Math.abs(c - s),
                        u = Math.abs(c - y),
                        p = Math.abs(c - v),
            ...
            e.prototype.decodePalette = function() {
                ...
                for (n = this.palette, o = this.transparency.indexed || [], i = new Uint8Array((o.length || 0) + n.length), r = 0, t = 0, e = s = 0, a = n.length; s < a; e = s += 3) i[r++] = n[e],
                i[r++] = n[e + 1],
                i[r++] = n[e + 2],
            ...
            e.prototype.copyToImageData = function(t, e) {
                var n, r, i, o, s, a, c, h, l, u, p;
                if (r = this.colors, l = null, n = this.hasAlphaChannel, this.palette.length && (l = null != (p = this._decodedPalette) ? p: this._decodedPalette = this.decodePalette(), r = 4, n = !0), i = t.data || t, h = i.length, s = l || e, o = a = 0, 1 === r) for (; o < h;) c = l ? 4 * e[o / 4] : a,
                u = s[c++],
                i[o++] = u,
                i[o++] = u,
                i[o++] = u,
            ...
            try {
                r = t.document.createElement("canvas"),
                i = r.getContext("2d")
            } catch(t) {
                return - 1
            }
            ...
            e.prototype.decodeFrames = function(t) {
                var e, r, i, o, s, a, c, h;
                if (this.animation) {
                    for (h = [], r = s = 0, a = (c = this.animation.frames).length; s < a; r = ++s) e = c[r],
                    i = t.createImageData(e.width, e.height),
                    o = this.decodePixels(new Uint8Array(e.data)),
            ...
            e.prototype.renderFrame = function(t, e) {
                var n, r, i;
                return r = this.animation.frames,
                n = r[e],
                i = r[e - 1],
 ...
 */
    ...
    o = function() {
        ...
        function e(e) {
            var n = 0,
            r = e[n++],
            o = e[n++]; - 1 != r && -1 != o || t("Invalid header in flate stream"),
            8 != (15 & r) && t("Unknown compression method in flate stream"),
            ((r << 8) + o) % 31 != 0 && t("Bad FCHECK in flate stream"),
            32 & o && t("FDICT bit set in flate stream"),
            this.bytes = e,
            this.bytesPos = n,
            this.codeSize = 0,
            this.codeBuf = 0,
        ...
        if ("undefined" != typeof Uint32Array) {
            ...
            o = new Uint32Array([1, 2, 3, 4, 65541, 65543, 131081, 131085, 196625, 196633, 262177, 262193, 327745, 327777, 393345, 393409, 459009, 459137, 524801, 525057, 590849, 591361, 657409, 658433, 724993, 727041, 794625, 798721, 868353, 876545]),
            ...
            e.prototype.getBits = function(e) {
                for (var n, r = this.codeSize,
                i = this.codeBuf,
                o = this.bytes,
                s = this.bytesPos; r < e;) void 0 === (n = o[s++]) && t("Bad encoding in flate stream"),
                i |= n << r,
                r += 8;
                return n = i & (1 << e) - 1,
                this.codeBuf = i >> e,
            ...
            e.prototype.getCode = function(e) {
                for (var n = e[0], r = e[1], i = this.codeSize, o = this.codeBuf, s = this.bytes, a = this.bytesPos; i < r;) {
                    var c;
                    void 0 === (c = s[a++]) && t("Bad encoding in flate stream"),
                    o |= c << i,
                    i += 8
                }
                var h = n[o & (1 << r) - 1],
                l = h >> 16,
                u = 65535 & h;
                return (0 == i || i < l || 0 == l) && t("Bad encoding in flate stream"),
                this.codeBuf = o >> l,
                this.codeSize = i - l,
                this.bytesPos = a,
                u
            ...
            e.prototype.generateHuffmanTable = function(t) {
                for (var e = t.length,
                n = 0,
                r = 0; r < e; ++r) t[r] > n && (n = t[r]);
                for (var i = 1 << n,
                o = new Uint32Array(i), s = 1, a = 0, c = 2; s <= n; ++s, a <<= 1, c <<= 1) for (var h = 0; h < e; ++h) if (t[h] == s) {
                    for (var l = 0,
                    u = a,
                    r = 0; r < s; ++r) l = l << 1 | 1 & u,
                    u >>= 1;
                    for (r = l; r < i; r += c) o[r] = s << 16 | h; ++a
                }
                return [o, n]
            },
            e.prototype.readBlock = function() {
                function e(t, e, n, r, i) {
                    for (var o = t.getBits(n) + r; o-->0;) e[d++] = i
                }
                ...
                if (1 & i && (this.eof = !0), 0 != (i >>= 1)) {
                    ...
                    h = a;
                        ...
                        for (var l = this.getBits(5) + 257, u = this.getBits(5) + 1, p = this.getBits(4) + 4, f = Array(n.length), d = 0; d < p;) f[n[d++]] = this.getBits(3);
                        for (var g = this.generateHuffmanTable(f), m = 0, d = 0, w = l + u, y = new Array(w); d < w;) {
                            var v = this.getCode(g);
                            16 == v ? e(this, y, 2, 3, m) : 17 == v ? e(this, y, 3, 3, m = 0) : 18 == v ? e(this, y, 7, 11, m = 0) : y[d++] = m = v
                        }
                        c = this.generateHuffmanTable(y.slice(0, l)),
                        h = this.generateHuffmanTable(y.slice(l, w))
                    } else t("Unknown block type in flate stream");
                    for (var b = (F = this.buffer) ? F.length: 0, x = this.bufferLength;;) {
                        var S = this.getCode(c);
                        if (S < 256) x + 1 >= b && (b = (F = this.ensureBuffer(x + 1)).length),
                        F[x++] = S;
                        else {
                            if (256 == S) return void(this.bufferLength = x);
                            var k = (S = r[S -= 257]) >> 16;
                            k > 0 && (k = this.getBits(k));
                            m = (65535 & S) + k;
                            S = this.getCode(h),
                            (k = (S = o[S]) >> 16) > 0 && (k = this.getBits(k));
                            var C = (65535 & S) + k;
                            x + m >= b && (b = (F = this.ensureBuffer(x + m)).length);
                            for (var I = 0; I < m; ++I, ++x) F[x] = F[x - C]
                        }
                    }
                } else {
                    var A, T = this.bytes,
                    _ = this.bytesPos;
                    void 0 === (A = T[_++]) && t("Bad block header in flate stream");
                    var q = A;
                    void 0 === (A = T[_++]) && t("Bad block header in flate stream"),
                    q |= A << 8,
                    void 0 === (A = T[_++]) && t("Bad block header in flate stream");
                    var O = A;
                    void 0 === (A = T[_++]) && t("Bad block header in flate stream"),
                    (O |= A << 8) != (65535 & ~q) && t("Bad uncompressed block length in flate stream"),
                    this.codeBuf = 0,
                    this.codeSize = 0;
                    var P = this.bufferLength,
                    F = this.ensureBuffer(P + q),
                    E = P + q;
                    this.bufferLength = E;
                    for (var B = P; B < E; ++B) {
                        if (void 0 === (A = T[_++])) {
    ...
    return function(t) {
        ...
        void 0 === t.btoa && (t.btoa = function(t) {
            ...
            if (!t) return t;
            do {
                n = (s = t.charCodeAt(a++) << 16 | t.charCodeAt(a++) << 8 | t.charCodeAt(a++)) >> 18 & 63, r = s >> 12 & 63, i = s >> 6 & 63, o = 63 & s, l[c++] = e.charAt(n) + e.charAt(r) + e.charAt(i) + e.charAt(o)
            } while ( a < t . length );
            h = l.join("");
            var u = t.length % 3;
            return (u ? h.slice(0, u - 3) : h) + "===".slice(u || 3)
        }),
        void 0 === t.atob && (t.atob = function(t) {
            ...
            t += "";
            do {
                n = (a = e.indexOf(t.charAt(c++)) << 18 | e.indexOf(t.charAt(c++)) << 12 | (o = e.indexOf(t.charAt(c++))) << 6 | (s = e.indexOf(t.charAt(c++)))) >> 16 & 255, r = a >> 8 & 255, i = 255 & a, l[h++] = 64 == o ? String.fromCharCode(n) : 64 == s ? String.fromCharCode(n, r) : String.fromCharCode(n, r, i)
            } while ( c < t . length );
            return l.join("")
        }),
        ...
        Object.keys || (Object.keys = function() {
            ...
            return function(i) {
                ...
                if (e) for (s = 0; s < r; s++) t.call(i, n[s]) && a.push(n[s]);
                return a
            }
        } ()),
