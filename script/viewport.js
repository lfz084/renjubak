...
view.prototype.resize = function() {
  ...
  this.viewport.setAttribute("content", "width=device-width, initial-scale=" +this.scale+",  user-scalable=0");
};

view.prototype.userScalable = function(scalable) {
  this.viewport.setAttribute("content", "initial-scale=" + 0.1);
  this.viewport.setAttribute("content", "width=device-width, initial-scale=" +this.scale+",  user-scalable=1");
};