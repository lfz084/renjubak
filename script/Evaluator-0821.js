...
const VCF_NODES_LEN = 3000000; // 3*1000000
let vcfHashTable = new Array(1453950), //16155*90
    vcfPositions = new Array(4520000), //226*20000
    vcfNodes = new Array(VCF_NODES_LEN);

function vcfHashTablePush(key, position) {
    
}

function vcfHashTableHasKey() {
    
}

function newVcfPosition() {
