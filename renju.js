...
var loadApp = () => { // 按顺序加载应用
    ...
    function testBrowser() {
        ...
        Msg += `serviceWorker.controller: ${"controller" in navigator.serviceWorker}\n`;
    ...
    return registerServiceWorker()
        ...
        .then(() => {
            loadAnimarion.open();
            loadAnimarion.lock(true);
            loadAnimarion.text("0%");
            return loadCssAll([
